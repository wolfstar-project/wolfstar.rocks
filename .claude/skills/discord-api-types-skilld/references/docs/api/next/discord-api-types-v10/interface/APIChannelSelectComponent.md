APIChannelSelectComponent | API | discord-api-types documentation
...
- APIBaseAutoPopulatedSelectMenuComponent<ComponentType.ChannelSelect,SelectMenuDefaultValueType.Channel>
  - _APIChannelSelectComponent_

## Index [__](#Index)

### Properties

- [__channel_types](#channel_types)
- [__custom_id](#custom_id)
- [__default_values](#default_values)
- [__disabled](#disabled)
- [__id](#id)
- [__max_values](#max_values)
- [__min_values](#min_values)
...
### [__](#channel_types) __optionalchannel_types

__channel_types?: ChannelType[]

List of channel types to include in the ChannelSelect component

### [__](#custom_id) __inheritedcustom_id

__custom_id: string

Inherited from APIBaseAutoPopulatedSelectMenuComponent.custom_id

A developer-defined identifier for the select menu, max 100 characters

### [__](#default_values) __optionalinheriteddefault_values

__default_values?: APISelectMenuDefaultValue<Channel>[]

Inherited from APIBaseAutoPopulatedSelectMenuComponent.default_values

List of default values for auto-populated select menu components

### [__](#disabled) __optionalinheriteddisabled

__disabled?: boolean

Inherited from APIBaseAutoPopulatedSelectMenuComponent.disabled
...
### [__](#id) __optionalinheritedid

__id?: number

Inherited from APIBaseAutoPopulatedSelectMenuComponent.id
...
### [__](#max_values) __optionalinheritedmax_values

__max_values?: number

Inherited from APIBaseAutoPopulatedSelectMenuComponent.max_values
...
### [__](#min_values) __optionalinheritedmin_values

__min_values?: number

Inherited from APIBaseAutoPopulatedSelectMenuComponent.min_values
...
### [__](#placeholder) __optionalinheritedplaceholder

__placeholder?: string

Inherited from APIBaseAutoPopulatedSelectMenuComponent.placeholder

Custom placeholder text if nothing is selected, max 150 characters

### [__](#required) __optionalinheritedrequired

__required?: boolean

Inherited from APIBaseAutoPopulatedSelectMenuComponent.required
...
__type: ChannelSelect

Inherited from APIBaseAutoPopulatedSelectMenuComponent.type

The type of the component

Previous APIChannelMention Next APIChatInputApplicationCommandInteractionData

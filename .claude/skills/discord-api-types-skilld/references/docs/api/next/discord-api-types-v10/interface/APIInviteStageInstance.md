APIInviteStageInstance | API | discord-api-types documentation
...
- [__members](#members)
- [__participant_count](#participant_count)
- [__speaker_count](#speaker_count)
- [__topic](#topic)
...
### [__](#participant_count) __participant_count

__participant_count: number

The number of users in the stage

### [__](#speaker_count) __speaker_count

__speaker_count: number
...
Previous APIInviteChannel Next APILabelComponent

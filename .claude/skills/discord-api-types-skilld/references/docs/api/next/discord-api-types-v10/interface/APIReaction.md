APIReaction | API | discord-api-types documentation
...
- [__burst_colors](#burst_colors)
- [__count](#count)
- [__count_details](#count_details)
- [__emoji](#emoji)
- [__me](#me)
- [__me_burst](#me_burst)
...
### [__](#burst_colors) __burst_colors

__burst_colors: string[]
...
### [__](#count_details) __count_details

__count_details: APIReactionCountDetails

An object detailing the individual reaction counts for different types of reactions

### [__](#emoji) __emoji

__emoji: APIPartialEmoji
...
### [__](#me_burst) __me_burst

__me_burst: boolean

Whether the current user super-reacted using this emoji

Previous APIRadioGroupOption Next APIReactionCountDetails

APIMessageRoleSelectInteractionData | API | discord-api-types documentation
...
- APIMessageComponentBaseInteractionData<ComponentType.RoleSelect>
  - _APIMessageRoleSelectInteractionData_
...
__resolved: Required<Pick< APIInteractionDataResolved,roles>>

### [__](#values) __values

__values: string[]

Previous APIMessageReference Next APIMessageRoleSubscriptionData

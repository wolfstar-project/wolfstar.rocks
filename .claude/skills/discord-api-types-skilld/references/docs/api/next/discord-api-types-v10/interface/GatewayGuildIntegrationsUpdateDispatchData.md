GatewayGuildIntegrationsUpdateDispatchData | API | discord-api-types documentation
...
Previous GatewayGuildEmojisUpdateDispatchData Next GatewayGuildMemberAddDispatchData

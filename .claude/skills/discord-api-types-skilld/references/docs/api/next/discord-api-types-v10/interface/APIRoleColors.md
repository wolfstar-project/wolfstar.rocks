APIRoleColors | API | discord-api-types documentation
...
https://discord.com/developers/docs/topics/permissions#role-colors-object
...
- [__tertiary_color](#tertiary_color)

## Properties [__](#Properties)

### [__](#primary_color) __primary_color

__primary_color: number

The primary color for the role

### [__](#secondary_color) __secondary_color

__secondary_color: null |number

The secondary color for the role, this will make the role a gradient between the other provided colors

### [__](#tertiary_color) __tertiary_color

__tertiary_color: null |number
...
Previous APIRole Next APIRoleTags

...
::: tip
The stack trace's total size is also typically limited by V8's `Error.stackTraceLimit` number. You could set this to a high value in your test setup function to prevent stacks from being truncated.
:::

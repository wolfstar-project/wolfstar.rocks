GatewayGuildBanModifyDispatchData | API | discord-api-types documentation
...
Previous GatewayGuildAuditLogEntryCreateDispatchData Next GatewayGuildCreateDispatchData

<template>
	<UContainer class="pt-20 sm:pt-24">
		<UPageHero title="WolfStar Privacy Policy" :ui="{ container: 'pb-12 sm:pb-16 lg:pb-20' }">
				...
				<article class="prose prose-lg max-w-none space-y-12">
					...
					<section>
						...
						<p class="leading-relaxed text-base-content">
							...
							chat platform, (the "Bot"), a website that serves as a dashboard (the
							"Site") and various related services (collectively, the "Service(s)").
							The Service is operated by WolfStar Project (the "Company", "we" or
							"us") for users of the Service ("you" or the "user(s)"). This privacy
							policy sets forth our policy with respect to information that is
							collected from visitors to the Site and users of the Bot and/or the
					...
					<section>
						...
						<p class="mb-4 leading-relaxed text-base-content">
							...
							but not be limited to usernames, Discord user data, or other content you
							send via the chat feature when interacting with the Bot.
						</p>
					</section>
					...
					<section>
						...
						<p class="leading-relaxed text-base-content">
							...
							website. Their purpose is to enhance your browsing experience by
							remembering certain preferences and settings.
						</p>
					</section>
					...
					<section>
						...
						<p class="mb-4 leading-relaxed text-base-content">
							We only use essential technical cookies for purposes strictly necessary
						...
						<ul class="list-none space-y-3 pl-0 text-base-content">
							<li class="flex items-start gap-3 leading-relaxed">
								...
								<span>
									...
									you connect your Discord account. It is essential for
									maintaining your authenticated session. This cookie is HTTP-only
							...
							<li class="flex items-start gap-3 leading-relaxed">
								...
								<span>
									...
									persist session identifiers for error correlation and session
									replay. These identifiers are used only for debugging and are
									not used for advertising; personal data is masked where
									possible.
								</span>
							</li>
							<li class="flex items-start gap-3 leading-relaxed">
								...
								<span>
									...
									infrastructure cookies required to deliver the site and are not
					...
					<section>
						...
						<p class="leading-relaxed text-base-content">
							In addition to session cookies, we use your browser's Local Storage to
							save your display preferences. This allows us to remember the theme
							(light/dark) and other settings you have selected, so you don't have to
							reconfigure them on each visit. This information is purely functional,
							stored only on your device, and contains no personal data nor is it used
							to track you. We use it exclusively to improve your experience on our
							website.
						</p>
					</section>
					...
					<section>
						...
						<p class="mb-4 leading-relaxed text-base-content">
							...
							according to your preferences. However, please note that rejecting
							essential cookies may prevent full access to the application.
						</p>
					...
					<section>
						...
						<p class="mb-4 leading-relaxed text-base-content">
							We use Sentry for error tracking and application monitoring. This helps
							us identify and fix bugs, improve performance, and ensure a better user
							experience.
						</p>
						<p class="mb-3 leading-relaxed text-base-content">
						...
						<p class="mt-4 leading-relaxed text-base-content">
							Session replays capture user interactions (clicks, scrolls, navigation)
							to help us understand how errors occur. Personal information entered in
							forms is automatically masked. Sentry may set first‑party cookies or use
							local storage to correlate sessions for error reporting and session
							replay; these mechanisms are used solely for debugging and are not used
							for advertising. To opt out of session replay, contact us at
							<NuxtLink to="mailto:contact@wolfstar.rocks"
								>contact@wolfstar.rocks</NuxtLink
							>. All data is processed in accordance with GDPR requirements and stored
							securely.
						</p>
					</section>
					...
					<section>
						...
						<p class="mb-4 leading-relaxed text-base-content">
							...
							access token in a secure, HTTP-only, encrypted session cookie. This
							token is used solely to authenticate requests on your behalf and access
							your Discord guilds where WolfStar is installed.
						</p>
						<p class="mb-3 leading-relaxed text-base-content">
						...
						<p class="mt-4 leading-relaxed text-base-content">
							We do not store your Discord password or credentials. We only access
							data necessary to provide the features you use. You can disconnect your
							account at any time from your profile page, which will delete your
							session and revoke our access.
						</p>
					</section>
						...
						<ul class="list-none space-y-3 pl-0 text-base-content">
							...
							<li class="flex items-start gap-3 leading-relaxed">
								...
								<span>
									...
									understand how users navigate our services and improve
									functionality.
								</span>
							</li>
							<li class="flex items-start gap-3 leading-relaxed">
								...
								<span>
									...
									and server activity to provide bot functionality and improve
									features. This data is stored securely and used only for service
									provision.
								</span>
							</li>
						</ul>
						...
						<ul class="list-none space-y-3 pl-0 text-base-content">
							...
							<li class="flex items-start gap-3 leading-relaxed">
								...
								<span>
									...
									companies or individuals to perform certain functions. Examples
									of such functions include accessing, modifying and adding to the
									open-source source code. In order to perform these functions
									they may require samples of any of the data stored by the
									Services. These people will however never have access to the
							...
							<li class="flex items-start gap-3 leading-relaxed">
								...
								<span>
									...
									comply with a legal obligation, (ii) protect and defend the
									rights or property of the Company or Related Companies, (iii)
					...
					<section>
						...
						<p class="leading-relaxed text-base-content">
							...
							<NuxtLink to="mailto:contact@wolfstar.rocks">
								contact@wolfstar.rocks </NuxtLink
							>. Note: In some countries, the age of digital consent is older than 13.
					...
					<section>
						...
						<p class="mb-4 leading-relaxed text-base-content">
							...
							sending an email to
							<NuxtLink
								to="mailto:contact@wolfstar.rocks"
								class="underline hover:opacity-70"
							>
								contact@wolfstar.rocks </NuxtLink
							>. Upon request we will start the process and provide you a link to
					...
					<section>
						...
						<p class="mb-4 leading-relaxed text-base-content">
							...
							>: We collect the following categories of personal information: Discord
							User ID and profile information; internet or other network information
							(how you interact with the application, pages visited); location
							information (because your IP address may indicate your general location,
							but only country/region level); device and browser information; and
							...
							WE COLLECT", "WHAT COOKIES DO WE USE", and "ERROR TRACKING AND
							MONITORING". We collect personal information for the business and
						...
						<p class="mb-4 leading-relaxed text-base-content">
							<span class="font-semibold">No Sale of Personal Information</span>: The
							CCPA sets forth certain obligations for businesses that sell personal

...
With a Nuxt project, there are lots of moving pieces - from [Nuxt modules](/modules) to other JavaScript libraries. Try to report the bug at the most relevant and specific place. That will likely be the Nuxt module causing an issue, or the upstream library that Nuxt is depending on.

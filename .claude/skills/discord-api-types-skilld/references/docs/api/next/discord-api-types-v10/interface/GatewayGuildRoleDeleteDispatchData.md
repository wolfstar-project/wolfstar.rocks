GatewayGuildRoleDeleteDispatchData | API | discord-api-types documentation
...
### [__](#role_id) __role_id

__role_id: string

The id of the role

Previous GatewayGuildMemberUpdateDispatchData Next GatewayGuildRoleModifyDispatchData

APIGuildOnboardingPrompt | API | discord-api-types documentation
...
- [__id](#id)
- [__in_onboarding](#in_onboarding)
- [__options](#options)
- [__required](#required)
- [__single_select](#single_select)
- [__title](#title)
- [__type](#type)
...
### [__](#in_onboarding) __in_onboarding

__in_onboarding: boolean

Indicates whether the prompt is present in the onboarding flow. If `false`, the prompt will only appear in the Channels & Roles tab

### [__](#options) __options

__options: APIGuildOnboardingPromptOption[]

Options available within the prompt

### [__](#required) __required

__required: boolean

Indicates whether the prompt is required before a user completes the onboarding flow

### [__](#single_select) __single_select

__single_select: boolean
...
__type: GuildOnboardingPromptType

Type of prompt

Previous APIGuildOnboarding Next APIGuildOnboardingPromptOption

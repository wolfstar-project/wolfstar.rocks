GatewayGuildSoundboardSoundDeleteDispatchData | API | discord-api-types documentation
...
Previous GatewayGuildScheduledEventUserRemoveDispatchData Next GatewayGuildSoundboardSoundsUpdateDispatchData

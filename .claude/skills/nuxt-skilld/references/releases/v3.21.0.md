...
Nuxt 4.3 and 3.21 bring powerful new features for layouts, caching, and developer experience &ndash; plus significant performance improvements under the hood.
...
- Add `build:stub` command for those that need it (c682b2681)
- Revert change to how type augments are inserted (6a238b576)
...
- Add root scripts to lint context (ee83838b4)
- Tidy up configs (ab131b464)
- Add `.nuxtrc` with test-utils setup (b5879351f)
- Add eslint ignore (87811234d)
- Upgrade `vite-node` separately from `vitest` (8114e886f)
- Lint docs with eslint (d2d5f6733)
- Lint (b9df0e847)
- Lint (0efcf01fa)
###  Tests

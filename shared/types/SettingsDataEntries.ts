...
export const ConfigurableRoles: Roles.Role[] = [
  {
    name: "Administrator",
    tooltip: "The administrator roles. Administrators have access to all moderation and management commands. Defaults to anyone with the \"Manage Server\" permission.",
    key: "rolesAdmin",
  },
  {
    name: "Initial",
...
export const ConfigurableIgnoreChannels: Channels.IgnoreChannel[] = [
  ...
  },
  {
    ...
    description: "Channels I should ignore for all three of deleted messages to log, checking for editing messages to log, and checking for added reactions.",

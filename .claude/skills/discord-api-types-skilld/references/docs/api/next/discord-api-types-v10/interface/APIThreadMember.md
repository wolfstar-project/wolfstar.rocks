APIThreadMember | API | discord-api-types documentation
...
- [__flags](#flags)
- [__id](#id)
- [__join_timestamp](#join_timestamp)
- [__member](#member)
- [__user_id](#user_id)
...
### [__](#join_timestamp) __join_timestamp

__join_timestamp: string
...
Previous APIThreadList Next APIThreadMetadata

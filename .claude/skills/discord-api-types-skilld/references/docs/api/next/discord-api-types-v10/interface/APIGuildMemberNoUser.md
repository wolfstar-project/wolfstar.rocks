APIGuildMemberNoUser | API | discord-api-types documentation
...
Inherited from NonNullable.joined_at
...
Previous APIGuildMemberJoined Next APIGuildMembershipScreening

...
|-----------------------------------|-------------------------|---------------------------------------------------------------------------|
| Nitro      | ~~`nitro.config.ts`~~   | Use [`nitro`](/docs/4.x/api/nuxt-config#nitro) key in `nuxt.config`       |
| PostCSS    | ~~`postcss.config.js`~~ | Use [`postcss`](/docs/4.x/api/nuxt-config#postcss) key in `nuxt.config`   |
| Vite          | ~~`vite.config.ts`~~    | Use [`vite`](/docs/4.x/api/nuxt-config#vite) key in `nuxt.config`         |
| webpack | ~~`webpack.config.ts`~~ | Use [`webpack`](/docs/4.x/api/nuxt-config#webpack-1) key in `nuxt.config` |

Here is a list of other common config files:

| Name                                         | Config File           | How To Configure                                                              |
|----------------------------------------------|-----------------------|-------------------------------------------------------------------------------|
| TypeScript | `tsconfig.json`       | [More Info](/docs/4.x/directory-structure/tsconfig)                           |

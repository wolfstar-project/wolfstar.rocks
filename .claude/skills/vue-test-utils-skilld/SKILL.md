...
# vuejs/test-utils `@vue/test-utils@2.4.11`
...
Use `skilld search "query" -p @vue/test-utils` instead of grepping `.skilld/` directories. Run `skilld search --guide -p @vue/test-utils` for full syntax, filters, and operators.

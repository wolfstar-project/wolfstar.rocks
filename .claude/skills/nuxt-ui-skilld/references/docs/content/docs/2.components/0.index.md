...
Check out the `Nuxt`{target="_blank"} and `Vue`{target="_blank"} Dashboard templates on GitHub for a real-life example.
::
...
::note{icon="i-simple-icons-github"}
Check out the `Nuxt`{target="_blank"} and `Vue`{target="_blank"} AI Chat templates on GitHub for a real-life example.
::

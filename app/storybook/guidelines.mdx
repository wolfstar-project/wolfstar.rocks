...
- `bg-base-200` — subtle section background
- `bg-base-300` — deeper background for nested surfaces
- `card-glass` / `card-glass-soft` / `card-glass-bordered` — glass-morphism card surfaces (see `app/assets/css/utilities.css`)

## Borders & Radius

- Use DaisyUI `border` or `border-base-300` for subtle separators
...
- Secondary or less important content: `bg-base-200` or `text-muted`

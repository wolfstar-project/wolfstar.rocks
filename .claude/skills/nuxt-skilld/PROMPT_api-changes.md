...
Search: `skilld search "deprecated" -p nuxt`, `skilld search "breaking" -p nuxt`, `skilld search "v4.4" -p nuxt`, `skilld search "v4.3" -p nuxt`, `skilld search "v4.2" -p nuxt`, `skilld search "Features" -p nuxt`
...
| Change type | v4.x | v3.x → v4.x migration | Older |
|-------------|:---:|:---:|:---:|
...
The "Older" column means ≤ v2.x — these changes are NOT useful because anyone on v4.x already migrated past them.

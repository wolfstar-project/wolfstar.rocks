APITextDisplayComponent | API | discord-api-types documentation
...
- APIBaseComponent<ComponentType.TextDisplay>
  - _APITextDisplayComponent_
...
Previous APITextBasedChannel Next APITextInputComponent

...
Any community modules are welcome to be listed on [the module list](/modules). To be listed, open an issue in the nuxt/modules repository. The Nuxt team can help you to apply best practices before listing.

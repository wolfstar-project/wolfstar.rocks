...
- Guild log routes live under `server/api/guilds/[guild]/logs/`; the client renders them in the Logs section of `/app` through `app/components/guild/logs/Panel.vue`

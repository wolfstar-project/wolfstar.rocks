APIInteractionDataResolvedGuildMember | API | discord-api-types documentation
...
- APIGuildMemberAvatar
- APIGuildMemberJoined
  - _APIInteractionDataResolvedGuildMember_
...
Previous APIInteractionDataResolvedChannelBase Next APIInteractionGuildMember

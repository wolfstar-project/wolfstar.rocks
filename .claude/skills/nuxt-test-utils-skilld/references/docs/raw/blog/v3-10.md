...
With #24894, we are now able to do this automatically for you when prerendering your site. Your [`useAsyncData`](/docs/api/composables/use-async-data) and [`useFetch`](/docs/api/composables/use-fetch) calls will be deduplicated and cached between renders of your site.
...
<read-more to="/docs/guide/going-further/experimental-features#sharedprerenderdata">
...
### <icon name="i-vscode-icons-file-type-node"></icon> Client-side Node.js support
...
<read-more to="https://github.com/nuxt/nuxt/releases/tag/v3.10.0" icon="i-simple-icons-github" target="_blank">

GatewayAutoModerationActionExecutionDispatchData | API | discord-api-types documentation
...
- [__action](#action)
- [__alert_system_message_id](#alert_system_message_id)
- [__channel_id](#channel_id)
- [__content](#content)
- [__guild_id](#guild_id)
- [__matched_content](#matched_content)
- [__matched_keyword](#matched_keyword)
- [__message_id](#message_id)
- [__rule_id](#rule_id)
- [__rule_trigger_type](#rule_trigger_type)
- [__user_id](#user_id)
...
__action: APIAutoModerationAction

The action which was executed

### [__](#alert_system_message_id) __optionalalert_system_message_id

__alert_system_message_id?: string
...
### [__](#matched_content) __matched_content

__matched_content: null |string

The substring in content that triggered the rule

`MESSAGE_CONTENT` (`1 << 15`) gateway intent is required to receive non-empty values from this field

### [__](#matched_keyword) __matched_keyword

__matched_keyword: null |string
...
### [__](#rule_id) __rule_id

__rule_id: string

The id of the rule which action belongs to

### [__](#rule_trigger_type) __rule_trigger_type

__rule_trigger_type: AutoModerationRuleTriggerType

The trigger type of rule which was triggered

### [__](#user_id) __user_id

__user_id: string

The id of the user which generated the content which triggered the rule

Previous GatewayApplicationCommandPermissionsUpdateDispatchData Next GatewayChannelPinsUpdateDispatchData

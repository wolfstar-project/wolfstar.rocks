APISectionComponent | API | discord-api-types documentation
...
- APIBaseComponent<ComponentType.Section>
  - _APISectionComponent_

## Index [__](#Index)

### Properties

- [__accessory](#accessory)
...
### [__](#accessory) __accessory

__accessory: APISectionAccessoryComponent

A thumbnail or a button component, with a future possibility of adding more compatible components

### [__](#components) __components

__components: APITextDisplayComponent[]
...
Previous APIRoleTags Next APISelectMenuDefaultValue

Generate SKILL.md section for "nuxt" v4.4.8.
...
| Resource | Path |
|----------|------|
| Docs | `./references/docs/llms.txt` |
| Package | `./references/pkg/` |
| Types | `./references/pkg/./types.d.ts` — **read this file directly** to verify exports |
...
- `./references/docs/1.getting-started/` (18 .md files)
- `./references/docs/2.directory-structure/` (17 .md files)
- `./references/docs/2.directory-structure/1.app/` (11 .md files)
- `./references/docs/3.guide/` (1 .md files)
- `./references/docs/3.guide/1.concepts/` (9 .md files)
- `./references/docs/3.guide/2.best-practices/` (3 .md files)
- `./references/docs/3.guide/3.ai/` (2 .md files)
- `./references/docs/3.guide/4.modules/` (9 .md files)
- `./references/docs/3.guide/5.recipes/` (4 .md files)
- `./references/docs/3.guide/6.going-further/` (12 .md files)
- `./references/docs/4.api/` (2 .md files)
- `./references/docs/4.api/1.components/` (16 .md files)
- `./references/docs/4.api/2.composables/` (32 .md files)
- `./references/docs/4.api/3.utils/` (29 .md files)
- `./references/docs/4.api/4.commands/` (16 .md files)
- `./references/docs/4.api/5.kit/` (18 .md files)
- `./references/docs/4.api/6.advanced/` (2 .md files)
- `./references/docs/5.community/` (6 .md files)
- `./references/docs/6.bridge/` (10 .md files)
- `./references/docs/7.migration/` (11 .md files)
...
Skip: obvious API usage, installation steps, general TypeScript/programming patterns not specific to this package, anything a developer would naturally write without reading the docs. Every item must be specific to nuxt — reject general programming advice that applies to any project.

Search: `skilld search "recommended" -p nuxt`, `skilld search "avoid" -p nuxt`

## Format

<format-example note="Illustrative structure only — replace placeholder names with real nuxt APIs">
```
## Best Practices

- Use nuxt's built-in `createX()`./references/docs/api.md#createx)

APIExternalGuildScheduledEvent | API | discord-api-types documentation
...
- APIGuildScheduledEventBase<GuildScheduledEventEntityType.External>
  - _APIExternalGuildScheduledEvent_
...
- [__entity_metadata](#entity_metadata)
- [__entity_type](#entity_type)
- [__guild_id](#guild_id)
- [__id](#id)
- [__image](#image)
- [__name](#name)
- [__privacy_level](#privacy_level)
- [__recurrence_rule](#recurrence_rule)
- [__scheduled_end_time](#scheduled_end_time)
- [__scheduled_start_time](#scheduled_start_time)
- [__status](#status)
- [__user_count](#user_count)
...
Overrides APIGuildScheduledEventBase.channel_id

The channel id in which the scheduled event will be hosted, or `null` if entity type is `EXTERNAL`

### [__](#creator) __optionalinheritedcreator

__creator?: APIUser

Inherited from APIGuildScheduledEventBase.creator

The user that created the scheduled event

### [__](#creator_id) __optionalinheritedcreator_id

__creator_id?: null |string

Inherited from APIGuildScheduledEventBase.creator_id

The id of the user that created the scheduled event

### [__](#description) __optionalinheriteddescription

__description?: null |string

Inherited from APIGuildScheduledEventBase.description

The description of the scheduled event

### [__](#entity_id) __inheritedentity_id

__entity_id: null |string

Inherited from APIGuildScheduledEventBase.entity_id

The id of the hosting entity associated with the scheduled event

### [__](#entity_metadata) __entity_metadata

__entity_metadata: Required< APIGuildScheduledEventEntityMetadata>

Overrides APIGuildScheduledEventBase.entity_metadata

The entity metadata for the scheduled event

### [__](#entity_type) __inheritedentity_type

__entity_type: External

Inherited from APIGuildScheduledEventBase.entity_type

The type of hosting entity associated with the scheduled event

### [__](#guild_id) __inheritedguild_id

__guild_id: string

Inherited from APIGuildScheduledEventBase.guild_id
...
Inherited from APIGuildScheduledEventBase.id

The id of the guild event

### [__](#image) __optionalinheritedimage

__image?: null |string

Inherited from APIGuildScheduledEventBase.image
...
Inherited from APIGuildScheduledEventBase.name

The name of the scheduled event

### [__](#privacy_level) __inheritedprivacy_level

__privacy_level: GuildScheduledEventPrivacyLevel

Inherited from APIGuildScheduledEventBase.privacy_level

The privacy level of the scheduled event

### [__](#recurrence_rule) __inheritedrecurrence_rule

__recurrence_rule: null | APIGuildScheduledEventRecurrenceRule

Inherited from APIGuildScheduledEventBase.recurrence_rule

The definition for how often this event should recur

### [__](#scheduled_end_time) __inheritedscheduled_end_time

__scheduled_end_time: null |string

Inherited from APIGuildScheduledEventBase.scheduled_end_time

The time at which the guild event will end, or `null` if the event does not have a scheduled time to end

### [__](#scheduled_start_time) __inheritedscheduled_start_time

__scheduled_start_time: string

Inherited from APIGuildScheduledEventBase.scheduled_start_time

The time the scheduled event will start

### [__](#status) __inheritedstatus

__status: GuildScheduledEventStatus

Inherited from APIGuildScheduledEventBase.status

The status of the scheduled event

### [__](#user_count) __optionalinheriteduser_count

__user_count?: number

Inherited from APIGuildScheduledEventBase.user_count

The number of users subscribed to the scheduled event

Previous APIExtendedInvite Next APIFileComponent

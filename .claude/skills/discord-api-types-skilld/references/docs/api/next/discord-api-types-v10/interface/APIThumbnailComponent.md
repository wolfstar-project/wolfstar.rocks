APIThumbnailComponent | API | discord-api-types documentation
...
- APIBaseComponent<ComponentType.Thumbnail>
  - _APIThumbnailComponent_
...
Previous APIThreadOnlyChannel Next APIUnavailableGuild

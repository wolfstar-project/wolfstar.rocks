GatewayGuildMemberUpdateDispatchData | API | discord-api-types documentation
...
- Required< APIGuildMemberUser>
  - _GatewayGuildMemberUpdateDispatchData_
...
### [__](#avatar) __inheritedavatar

__avatar: null |string

Inherited from Required.avatar
...
Inherited from APIBaseGuildMember.avatar_decoration_data
...
### [__](#banner) __inheritedbanner

__banner: null |string

Inherited from Required.banner
...
Inherited from APIBaseGuildMember.collectibles
...
Inherited from APIBaseGuildMember.communication_disabled_until

Timestamp of when the time out will be removed; until then, they cannot interact with the guild

### [__](#deaf) __optionalinheriteddeaf

__deaf?: boolean

Inherited from Partial.deaf
...
Inherited from APIGuildMemberJoined.joined_at

When the user joined the guild

### [__](#mute) __optionalinheritedmute

__mute?: boolean

Inherited from Partial.mute
...
Inherited from APIBaseGuildMember.nick
...
Inherited from APIBaseGuildMember.pending
...
Inherited from APIBaseGuildMember.premium_since
...
Inherited from APIBaseGuildMember.roles
...
Previous GatewayGuildMembersChunkPresence Next GatewayGuildRoleDeleteDispatchData

APIAutoModerationRule | API | discord-api-types documentation
...
- [__exempt_channels](#exempt_channels)
- [__exempt_roles](#exempt_roles)
- [__guild_id](#guild_id)
- [__id](#id)
- [__name](#name)
- [__trigger_metadata](#trigger_metadata)
- [__trigger_type](#trigger_type)

## Properties [__](#Properties)

### [__](#actions) __actions

__actions: APIAutoModerationAction[]

The actions which will execute when this rule is triggered

### [__](#creator_id) __creator_id

__creator_id: string

The user id who created this rule

### [__](#enabled) __enabled

__enabled: boolean

Whether this rule is enabled

### [__](#event_type) __event_type

__event_type: AutoModerationRuleEventType

The rule event type

### [__](#exempt_channels) __exempt_channels

__exempt_channels: string[]

The channel ids that shouldn't be affected by this rule (Maximum of 50)

### [__](#exempt_roles) __exempt_roles

__exempt_roles: string[]
...
### [__](#trigger_metadata) __trigger_metadata

__trigger_metadata: APIAutoModerationRuleTriggerMetadata

The rule trigger metadata

### [__](#trigger_type) __trigger_type

__trigger_type: AutoModerationRuleTriggerType

The rule trigger type

Previous APIAutoModerationActionMetadata Next APIAutoModerationRuleTriggerMetadata

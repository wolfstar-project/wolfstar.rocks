...
```bash
npx -y skilld search "query" -p @sapphire/ratelimits
npx -y skilld search "issues:error handling" -p @sapphire/ratelimits
npx -y skilld search "releases:deprecated" -p @sapphire/ratelimits
```

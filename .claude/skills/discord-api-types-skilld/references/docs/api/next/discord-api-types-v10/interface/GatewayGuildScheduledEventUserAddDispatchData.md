GatewayGuildScheduledEventUserAddDispatchData | API | discord-api-types documentation
...
Previous GatewayGuildRoleModifyDispatchData Next GatewayGuildScheduledEventUserRemoveDispatchData

APIApplicationCommandNumberOptionBase | API | discord-api-types documentation
...
- APIApplicationCommandOptionBase<ApplicationCommandOptionType.Number>
  - _APIApplicationCommandNumberOptionBase_
...
### [__](#max_value) __optionalmax_value

__max_value?: number

If the option is an `INTEGER` or `NUMBER` type, the maximum value permitted.

### [__](#min_value) __optionalmin_value
...
Previous APIApplicationCommandInteractionMetadata Next APIApplicationCommandOptionBase

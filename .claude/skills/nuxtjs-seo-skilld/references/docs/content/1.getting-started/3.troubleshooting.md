...
When filing issues, include a minimal reproduction. See [Debugging Modules](/docs/nuxt-seo/guides/debugging-modules#creating-a-minimal-reproduction) for StackBlitz playgrounds.

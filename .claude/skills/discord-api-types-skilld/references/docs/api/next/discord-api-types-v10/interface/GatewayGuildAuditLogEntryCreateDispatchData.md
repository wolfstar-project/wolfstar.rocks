GatewayGuildAuditLogEntryCreateDispatchData | API | discord-api-types documentation
...
- APIAuditLogEntry
  - _GatewayGuildAuditLogEntryCreateDispatchData_
...
### [__](#action_type) __inheritedaction_type

__action_type: AuditLogEvent

Inherited from APIAuditLogEntry.action_type
...
### [__](#changes) __optionalinheritedchanges

__changes?: APIAuditLogChange[]

Inherited from APIAuditLogEntry.changes
...
Inherited from APIAuditLogEntry.id

ID of the entry

### [__](#options) __optionalinheritedoptions

__options?: APIAuditLogOptions

Inherited from APIAuditLogEntry.options
...
### [__](#reason) __optionalinheritedreason

__reason?: string

Inherited from APIAuditLogEntry.reason

The reason for the change (0-512 characters)

### [__](#target_id) __inheritedtarget_id

__target_id: null |string

Inherited from APIAuditLogEntry.target_id

ID of the affected entity (webhook, user, role, etc.)

### [__](#user_id) __inheriteduser_id

__user_id: null |string

Inherited from APIAuditLogEntry.user_id

The user who made the changes

This can be `null` in some cases (webhooks deleting themselves by using their own token, for example)

Previous GatewayChannelPinsUpdateDispatchData Next GatewayGuildBanModifyDispatchData

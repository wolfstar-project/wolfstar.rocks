    ...
    return async <T = unknown>(
      ...
      if (cached) {
        ...
        if (!isStale) {
          ...
          import.meta.dev
            && logger.info(`[fetch-cache] HIT (fresh): ${url}`);
        ...
        import.meta.dev
          && logger.info(`[fetch-cache] HIT (stale, revalidating): ${url}`);
        ...
        event.waitUntil(
          (async () => {
            try {
              ...
              import.meta.dev
                && logger.info(`[fetch-cache] Revalidated: ${url}`);
            }
            catch (error) {
              import.meta.dev
      ...
      import.meta.dev
        && logger.info(`[fetch-cache] MISS: ${url}`);

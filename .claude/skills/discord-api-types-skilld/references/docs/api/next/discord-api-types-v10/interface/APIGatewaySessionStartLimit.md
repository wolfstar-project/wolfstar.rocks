APIGatewaySessionStartLimit | API | discord-api-types documentation
...
- [__max_concurrency](#max_concurrency)
- [__remaining](#remaining)
- [__reset_after](#reset_after)
- [__total](#total)

## Properties [__](#Properties)

### [__](#max_concurrency) __max_concurrency

__max_concurrency: number

The number of identify requests allowed per 5 seconds

### [__](#remaining) __remaining

__remaining: number

The remaining number of session starts the current user is allowed

### [__](#reset_after) __reset_after

__reset_after: number
...
Previous APIGatewayInfo Next APIGroupDMChannel

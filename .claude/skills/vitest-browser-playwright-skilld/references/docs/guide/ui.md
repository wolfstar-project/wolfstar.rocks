...
This adds a link to the job summary. Click it to open the report in Vitest Viewer directly in the browser. You can also download the artifact manually and extract it, then run `vite preview` locally as above.
:::
...
::: info
All of the provided images use Zammad repository as an example.
:::
...
- Transformed: the transformed code that Vitest executes using Vite's module runner

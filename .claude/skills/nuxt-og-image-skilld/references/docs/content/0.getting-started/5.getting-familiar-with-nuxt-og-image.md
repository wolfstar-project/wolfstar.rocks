...
**Prerequisites:** [Install the module](/docs/og-image/getting-started/installation) and enable Nuxt DevTools.
::
...
Or copy and paste the template manually from the `Community` tab in Nuxt DevTools or GitHub.
...
Tailwind v4, UnoCSS, CSS variables, and Nuxt UI v3 colors are all supported by default. You can learn more in the [Styling](/docs/og-image/guides/styling) guide.
...
If you have any questions, on Discord or GitHub.

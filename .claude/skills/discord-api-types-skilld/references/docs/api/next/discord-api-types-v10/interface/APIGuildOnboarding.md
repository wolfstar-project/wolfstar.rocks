APIGuildOnboarding | API | discord-api-types documentation
...
- [__default_channel_ids](#default_channel_ids)
- [__enabled](#enabled)
- [__guild_id](#guild_id)
- [__mode](#mode)
- [__prompts](#prompts)
...
### [__](#default_channel_ids) __default_channel_ids

__default_channel_ids: string[]
...
__mode: GuildOnboardingMode

Current mode of onboarding

### [__](#prompts) __prompts

__prompts: APIGuildOnboardingPrompt[]

Prompts shown during onboarding and in customize community

Previous APIGuildMemberUser Next APIGuildOnboardingPrompt

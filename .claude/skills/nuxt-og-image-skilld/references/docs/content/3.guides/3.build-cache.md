...
When using pnpm, this will be in the `node_modules/.pnpm` directory's cache structure. Consider using a [custom cache directory](#custom-cache-directory) for consistency.
::

APIModalSubmission | API | discord-api-types documentation
...
__components: APIModalSubmissionComponent[]
...
Previous APIModalInteractionResponseCallbackData Next APIModalSubmitChannelSelectComponent

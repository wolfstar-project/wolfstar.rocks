APIGroupDMChannel | API | discord-api-types documentation
...
- APIDMChannelBase<ChannelType.GroupDM>
  - _APIGroupDMChannel_
...
Inherited from APIDMChannelBase.flags

### [__](#icon) __optionalicon
...
Inherited from APIDMChannelBase.id
...
Overrides APIDMChannelBase.last_message_id
...
Inherited from APIDMChannelBase.last_pin_timestamp

When the last pinned message was pinned. This may be `null` in events such as `GUILD_CREATE` when a message is not pinned

### [__](#managed) __optionalmanaged
...
### [__](#owner_id) __optionalowner_id
...
Inherited from APIDMChannelBase.rate_limit_per_user
...
### [__](#recipients) __optionalinheritedrecipients

__recipients?: APIUser[]

Inherited from APIDMChannelBase.recipients
...
Inherited from APIDMChannelBase.type
...
Previous APIGatewaySessionStartLimit Next APIGuild

GuildScheduledEventPrivacyLevel | API | discord-api-types documentation
...
- [__GuildOnly](#GuildOnly)

## Enumeration Members [__](#Enumeration Members)

### [__](#GuildOnly) __GuildOnly

__GuildOnly: 2

The scheduled event is only accessible to guild members

Previous GuildScheduledEventEntityType Next GuildScheduledEventRecurrenceRuleFrequency

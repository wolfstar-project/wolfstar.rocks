...
> Nuxt is a community project - and so we love contributions of all kinds! 
...
- nuxt-modules/ - community-contributed and maintained modules and libraries. There is a [process to migrate a module](/docs/4.x/guide/modules/ecosystem) to `nuxt-modules`. While these modules have individual maintainers, they are not dependent on a single person.
...
Check out the issues and discussions for the project you want to help. For example, here are the issues board and discussions for Nuxt. Helping other users, sharing workarounds, creating reproductions, or even poking into a bug a little bit and sharing your findings makes a huge difference.
...
Our aim is ensuring quality and maintaining the joy of collaborating and communicating with real people. If you have ideas for improving our policy on AI in the Nuxt community, we'd love to hear them! 
...
Modules should follow the Nuxt module template. See [module guide](/docs/4.x/guide/modules) for more information.
...
- obuild - rolldown-powered build system
...
- Avoid subjective words like *simply*, *just*, *obviously...* when possible.<br />

Keep in mind your readers can have different backgrounds and experiences. Therefore, these words don't convey meaning and can be harmful.<caution icon="i-lucide-circle-x">
...
- Prefer active voice.<caution icon="i-lucide-circle-x">

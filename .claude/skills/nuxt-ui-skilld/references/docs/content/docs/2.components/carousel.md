...
You can use the [`emblaApi`](#expose) function scrollTo to display thumbnails under the carousel that allows you to navigate to a specific slide.
...
| `emblaApi`{lang="ts-type"} | `Ref<EmblaCarouselType \| null>`{lang="ts-type"} |

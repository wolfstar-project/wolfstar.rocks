APIWebhookEventApplicationAuthorizedData | API | discord-api-types documentation
...
__integration_type?: ApplicationIntegrationType
...
Previous APIWebhook Next APIWebhookEventApplicationDeauthorizedData

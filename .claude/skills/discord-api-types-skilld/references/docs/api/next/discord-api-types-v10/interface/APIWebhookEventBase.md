APIWebhookEventBase | API | discord-api-types documentation
...
# APIWebhookEventBase <Type,Event>
...
Previous APIWebhookEventApplicationDeauthorizedData Next APIWebhookEventEventBase

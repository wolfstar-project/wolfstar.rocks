GatewayGuildStickersUpdateDispatchData | API | discord-api-types documentation
...
Previous GatewayGuildSoundboardSoundsUpdateDispatchData Next GatewayHeartbeat

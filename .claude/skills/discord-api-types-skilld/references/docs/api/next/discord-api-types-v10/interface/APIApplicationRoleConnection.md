APIApplicationRoleConnection | API | discord-api-types documentation
...
- [__metadata](#metadata)
- [__platform_name](#platform_name)
- [__platform_username](#platform_username)

## Properties [__](#Properties)

### [__](#metadata) __metadata

__metadata: Record<string,string |number>

Object mapping application role connection metadata keys to their `string`-ified value (max 100 characters) for the user on the platform a bot has connected

### [__](#platform_name) __platform_name

__platform_name: null |string

The vanity name of the platform a bot has connected (max 50 characters)

### [__](#platform_username) __platform_username

__platform_username: null |string

The username on the platform a bot has connected (max 100 characters)

Previous APIApplicationIntegrationTypeConfiguration Next APIApplicationRoleConnectionMetadata

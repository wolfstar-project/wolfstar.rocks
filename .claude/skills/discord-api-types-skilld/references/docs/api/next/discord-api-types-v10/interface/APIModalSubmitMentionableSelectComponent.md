APIModalSubmitMentionableSelectComponent | API | discord-api-types documentation
...
- APIBaseModalSubmitComponent<ComponentType.MentionableSelect>
  - _APIModalSubmitMentionableSelectComponent_
...
Inherited from APIBaseModalSubmitComponent.custom_id

### [__](#id) __optionalinheritedid

__id?: number

Inherited from APIBaseModalSubmitComponent.id
...
__type: MentionableSelect

Inherited from APIBaseModalSubmitComponent.type
...
Previous APIModalSubmitInteractionMetadata Next APIModalSubmitRadioGroupComponent

GatewayGuildMemberRemoveDispatchData | API | discord-api-types documentation
...
Previous GatewayGuildMemberAddDispatchData Next GatewayGuildMembersChunkDispatchData

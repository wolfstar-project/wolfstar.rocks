	...
	compoundVariants: [
		{
			...
			class: {
				...
				itemLeadingIcon:
					"text-primary/75 group-data-highlighted:text-primary group-data-[state=open]:text-primary group-data-highlighted:scale-110 group-data-[state=open]:scale-110 transition-all duration-200",
			},
			color: "primary",
		},
		{

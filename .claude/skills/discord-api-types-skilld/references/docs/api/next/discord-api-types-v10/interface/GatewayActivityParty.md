GatewayActivityParty | API | discord-api-types documentation
...
__size?: [current_size:number,max_size:number]

Used to show the party's current and maximum size

Previous GatewayActivityButton Next GatewayActivitySecrets

APIMessageComponentBaseInteractionData | API | discord-api-types documentation
...
# APIMessageComponentBaseInteractionData <CType>

### Hierarchy

- _APIMessageComponentBaseInteractionData_
  - APIMessageStringSelectInteractionData
  - APIMessageUserSelectInteractionData
  - APIMessageRoleSelectInteractionData
  - APIMessageMentionableSelectInteractionData
...
### [__](#component_type) __component_type

__component_type: CType
...
Previous APIMessageChannelSelectInteractionData Next APIMessageComponentEmoji

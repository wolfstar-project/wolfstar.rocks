export default {
  ...
  variants: {
    ...
    active: {
      true: {
        item: "text-highlighted before:bg-base-100",
        itemLeadingIcon: "text-default",
      },
      false: {
        item: [
          "text-default data-highlighted:text-highlighted data-[state=open]:text-highlighted data-highlighted:before:bg-base-100/50 data-[state=open]:before:bg-base-100/50",

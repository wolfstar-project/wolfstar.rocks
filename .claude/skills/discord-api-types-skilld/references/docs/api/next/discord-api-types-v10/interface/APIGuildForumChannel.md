APIGuildForumChannel | API | discord-api-types documentation
...
- APIThreadOnlyChannel<ChannelType.GuildForum>
  - _APIGuildForumChannel_

## Index [__](#Index)

### Properties

- [__available_tags](#available_tags)
- [__default_auto_archive_duration](#default_auto_archive_duration)
- [__default_forum_layout](#default_forum_layout)
- [__default_reaction_emoji](#default_reaction_emoji)
- [__default_sort_order](#default_sort_order)
- [__default_thread_rate_limit_per_user](#default_thread_rate_limit_per_user)
- [__flags](#flags)
- [__guild_id](#guild_id)
- [__id](#id)
- [__last_message_id](#last_message_id)
- [__last_pin_timestamp](#last_pin_timestamp)
- [__name](#name)
- [__nsfw](#nsfw)
- [__parent_id](#parent_id)
- [__permission_overwrites](#permission_overwrites)
- [__position](#position)
- [__rate_limit_per_user](#rate_limit_per_user)
- [__topic](#topic)
- [__type](#type)

## Properties [__](#Properties)

### [__](#available_tags) __inheritedavailable_tags

__available_tags: APIGuildForumTag[]

Inherited from APIThreadOnlyChannel.available_tags

The set of tags that can be used in a thread-only channel

### [__](#default_auto_archive_duration) __optionalinheriteddefault_auto_archive_duration

__default_auto_archive_duration?: ThreadAutoArchiveDuration

Inherited from APIThreadOnlyChannel.default_auto_archive_duration

Default duration for newly created threads, in minutes, to automatically archive the thread after recent activity

### [__](#default_forum_layout) __default_forum_layout

__default_forum_layout: ForumLayoutType

The default layout type used to display posts in a forum channel

<dl><dt>**@defaultValue**</dt>
<dd>
...
### [__](#default_reaction_emoji) __inheriteddefault_reaction_emoji

__default_reaction_emoji: null | APIGuildForumDefaultReactionEmoji

Inherited from APIThreadOnlyChannel.default_reaction_emoji

The emoji to show in the add reaction button on a thread in a thread-only channel

### [__](#default_sort_order) __inheriteddefault_sort_order

__default_sort_order: null | SortOrderType

Inherited from APIThreadOnlyChannel.default_sort_order

The default sort order type used to order posts in a thread-only channel

### [__](#default_thread_rate_limit_per_user) __optionalinheriteddefault_thread_rate_limit_per_user

__default_thread_rate_limit_per_user?: number

Inherited from APIThreadOnlyChannel.default_thread_rate_limit_per_user
...
__flags?: ChannelFlags

Inherited from APIThreadOnlyChannel.flags

### [__](#guild_id) __optionalinheritedguild_id

__guild_id?: string

Inherited from APIThreadOnlyChannel.guild_id
...
Inherited from APIThreadOnlyChannel.id

The id of the channel

### [__](#last_message_id) __optionalinheritedlast_message_id

__last_message_id?: null |string

Inherited from APIThreadOnlyChannel.last_message_id

The id of the last thread created in this channel (may not point to an existing or valid thread)

### [__](#last_pin_timestamp) __optionalinheritedlast_pin_timestamp

__last_pin_timestamp?: null |string

Inherited from APIThreadOnlyChannel.last_pin_timestamp

When the last pinned message was pinned. This may be `null` in events such as `GUILD_CREATE` when a message is not pinned

### [__](#name) __inheritedname

__name: string

Inherited from APIThreadOnlyChannel.name

The name of the channel (1-100 characters)

### [__](#nsfw) __optionalinheritednsfw

__nsfw?: boolean

Inherited from APIThreadOnlyChannel.nsfw

Whether the channel is nsfw

### [__](#parent_id) __optionalinheritedparent_id

__parent_id?: null |string

Inherited from APIThreadOnlyChannel.parent_id

ID of the parent category for a channel (each parent category can contain up to 50 channels)

### [__](#permission_overwrites) __optionalinheritedpermission_overwrites

__permission_overwrites?: APIOverwrite[]

Inherited from APIThreadOnlyChannel.permission_overwrites
...
### [__](#position) __inheritedposition

__position: number

Inherited from APIThreadOnlyChannel.position

Sorting position of the channel

### [__](#rate_limit_per_user) __optionalinheritedrate_limit_per_user

__rate_limit_per_user?: number

Inherited from APIThreadOnlyChannel.rate_limit_per_user

Amount of seconds a user has to wait before creating another thread (0-21600); bots, as well as users with the permission `BYPASS_SLOWMODE`, are unaffected

The absence of this field in API calls and Gateway events should indicate that slowmode has been reset to the default value.

### [__](#topic) __optionalinheritedtopic

__topic?: null |string

Inherited from APIThreadOnlyChannel.topic
...
Inherited from APIThreadOnlyChannel.type
...
Previous APIGuildChannel Next APIGuildForumDefaultReactionEmoji

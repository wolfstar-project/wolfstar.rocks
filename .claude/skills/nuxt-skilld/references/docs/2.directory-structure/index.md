...
The [`content/`](/docs/4.x/directory-structure/content) directory is enabled by the Nuxt Content module. It is used to create a file-based CMS for your application using Markdown files.

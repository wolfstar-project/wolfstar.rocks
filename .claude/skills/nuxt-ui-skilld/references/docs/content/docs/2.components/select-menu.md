...
::tip
Use this over a [`Select`](/docs/components/select) to take advantage of Reka UI's `Combobox` component that offers search capabilities and multiple selection.
::

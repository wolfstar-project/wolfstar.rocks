CI/CD in Node.js with Dagger | Dotenv
...
```shell
DOTENV_KEY='dotenv://: [\[email protected\]](https://www.dotenv.org/cdn-cgi/l/email-protection)/vault/.env.vault?environment=ci' node ci/index.mjs
```

...
- **Takumi as recommended renderer** - Takumi is 2-10x faster than Satori with the same feature set
- **First-class CSS support** - Tailwind v4, UnoCSS, CSS variables, and Nuxt UI v3 colors all work
...
Nuxt OG Image has native Tailwind v4 support. The module extracts classes from your OG components at build time and compiles them with Tailwind's CSS engine. Zero-config - the module auto-detects your Tailwind setup whether you're using `@nuxtjs/tailwindcss` or Tailwind v4 with the Vite plugin.

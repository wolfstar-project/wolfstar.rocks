APIBaseInteractionMetadata | API | discord-api-types documentation
...
# APIBaseInteractionMetadata <Type>

### Hierarchy

- _APIBaseInteractionMetadata_
  - APIApplicationCommandInteractionMetadata
  - APIMessageComponentInteractionMetadata
  - APIModalSubmitInteractionMetadata
...
### [__](#original_response_message_id) __optionaloriginal_response_message_id
...
Previous APIBaseInteraction Next APIBaseMessage

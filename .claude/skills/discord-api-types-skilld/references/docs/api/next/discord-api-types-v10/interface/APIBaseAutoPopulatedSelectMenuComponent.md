APIBaseAutoPopulatedSelectMenuComponent | API | discord-api-types documentation
...
# APIBaseAutoPopulatedSelectMenuComponent <T,D>
...
- APIBaseSelectMenuComponent<T>
  - _APIBaseAutoPopulatedSelectMenuComponent_
    - APIChannelSelectComponent
...
Inherited from APIBaseSelectMenuComponent.custom_id

A developer-defined identifier for the select menu, max 100 characters

### [__](#default_values) __optionaldefault_values

__default_values?: APISelectMenuDefaultValue<D>[]
...
Inherited from APIBaseSelectMenuComponent.disabled
...
Inherited from APIBaseSelectMenuComponent.id
...
Inherited from APIBaseSelectMenuComponent.max_values
...
Inherited from APIBaseSelectMenuComponent.min_values
...
Inherited from APIBaseSelectMenuComponent.placeholder
...
Inherited from APIBaseSelectMenuComponent.required
...
Inherited from APIBaseSelectMenuComponent.type

The type of the component

Previous APIBaseApplicationCommandInteractionData Next APIBaseComponent

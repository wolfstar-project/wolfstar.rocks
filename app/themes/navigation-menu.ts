export default {
  slots: {
    ...
    viewport: "relative overflow-hidden bg-base-200/60 backdrop-blur-sm shadow-lg rounded-md ring ring-default h-(--reka-navigation-menu-viewport-height) w-full transition-[width,height,left] duration-200 origin-[top_center] data-[state=open]:animate-[scale-in_100ms_ease-out] data-[state=closed]:animate-[scale-out_100ms_ease-in] z-[1]",
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      class: {
        ...
        content: "data-[state=open]:animate-[collapsible-down_200ms_ease-out] data-[state=closed]:animate-[collapsible-up_200ms_ease-out] overflow-hidden bg-base-200/60 backdrop-blur-sm",
      },
    },
    {
      orientation: "vertical",

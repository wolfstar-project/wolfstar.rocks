APIMessageRoleSubscriptionData | API | discord-api-types documentation
...
- [__is_renewal](#is_renewal)
- [__role_subscription_listing_id](#role_subscription_listing_id)
- [__tier_name](#tier_name)
- [__total_months_subscribed](#total_months_subscribed)

## Properties [__](#Properties)

### [__](#is_renewal) __is_renewal

__is_renewal: boolean

Whether this notification is for a renewal

### [__](#role_subscription_listing_id) __role_subscription_listing_id

__role_subscription_listing_id: string

The id of the SKU and listing the user is subscribed to

### [__](#tier_name) __tier_name

__tier_name: string

The name of the tier the user is subscribed to

### [__](#total_months_subscribed) __total_months_subscribed

__total_months_subscribed: number

The number of months the user has been subscribed for

Previous APIMessageRoleSelectInteractionData Next APIMessageSearchIndexNotReadyResponse

Generate SKILL.md section for "dotenv" v17.4.2.
...
| Types | `./references/pkg/lib/main.d.ts` — **read this file directly** to verify exports |
...
- `./references/discussions/` (17 .md files)
- `./references/docs/` (10 .md files)
- `./references/docs/docs/` (6 .md files)
- `./references/docs/docs/addons/` (7 .md files)
- `./references/docs/docs/cis/` (3 .md files)
- `./references/docs/docs/dotenv-vault/` (13 .md files)
- `./references/docs/docs/features/` (9 .md files)
- `./references/docs/docs/frameworks/` (7 .md files)
- `./references/docs/docs/help/` (2 .md files)
- `./references/docs/docs/languages/` (8 .md files)
- `./references/docs/docs/platforms/` (7 .md files)
- `./references/docs/docs/quickstart/` (4 .md files)
- `./references/docs/docs/security/` (6 .md files)
- `./references/docs/docs/sync/` (1 .md files)
- `./references/docs/docs/tutorials/` (5 .md files)
- `./references/docs/legal/` (2 .md files)
- `./references/docs/vault/` (2 .md files)
- `./references/issues/` (16 .md files)
- `./references/pkg/` (4 .md files)
- `./references/pkg-dotenv/` (4 .md files)
- `./references/pkg-dotenv/skills/dotenv/` (1 .md files)
- `./references/pkg-dotenv/skills/dotenvx/` (1 .md files)
- `./references/pkg/skills/dotenv/` (1 .md files)
- `./references/pkg/skills/dotenvx/` (1 .md files)
</external-docs>
...
Skip: obvious API usage, installation steps, general TypeScript/programming patterns not specific to this package, anything a developer would naturally write without reading the docs. Every item must be specific to dotenv — reject general programming advice that applies to any project.

Search: `skilld search "recommended" -p dotenv`, `skilld search "avoid" -p dotenv`

## Format

<format-example note="Illustrative structure only — replace placeholder names with real dotenv APIs">
```
## Best Practices

- Use dotenv's built-in `createX()`./references/docs/api.md#createx)

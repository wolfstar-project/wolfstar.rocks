...
The locator API uses a fork of Playwright's locators called Ivya. However, Vitest provides this API to every [provider](/config/browser/provider), not just playwright.

APIVoiceRegion | API | discord-api-types documentation
...
### [__](#optimal) __optimal

__optimal: boolean

`true` for a single server that is closest to the current user's client

Previous APIVoiceGuildScheduledEvent Next APIVoiceState

 ...
 */
seconds.fromMinutes = (minutes: number): number => minutes * 60;
 ...
 */
seconds.fromHours = (hours: number): number => hours * 60 * 60;
 ...
 */
seconds.fromDays = (days: number): number => days * 60 * 60 * 24;

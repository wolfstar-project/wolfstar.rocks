APIButtonComponentBase | API | discord-api-types documentation
...
Inherited from APIButtonBase.disabled

The status of the button

### [__](#emoji) __optionalemoji
...
Inherited from APIButtonBase.id
...
Inherited from APIButtonBase.style
...
Inherited from APIButtonBase.type

The type of the component

Previous APIButtonBase Next APIButtonComponentWithCustomId

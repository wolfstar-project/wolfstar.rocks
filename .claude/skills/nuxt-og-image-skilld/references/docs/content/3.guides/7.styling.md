...
Nuxt OG Image supports modern CSS via Tailwind v4, UnoCSS, and standard CSS. Your level of CSS support depends on the chosen renderer.
...
The module uses Lightning CSS to process styles for simpler renderers like Satori:

APIMessageComponentInteractionMetadata | API | discord-api-types documentation
...
- APIBaseInteractionMetadata<InteractionType.MessageComponent>
  - _APIMessageComponentInteractionMetadata_
...
- [__id](#id)
- [__interacted_message_id](#interacted_message_id)
...
### [__](#interacted_message_id) __interacted_message_id

__interacted_message_id: string
...
Previous APIMessageComponentEmoji Next APIMessageInteraction

...
A list of glob patterns that match your [in-source test files](/guide/in-source). These patterns are resolved relative to the [`root`](/config/root) (`process.cwd()` by default).

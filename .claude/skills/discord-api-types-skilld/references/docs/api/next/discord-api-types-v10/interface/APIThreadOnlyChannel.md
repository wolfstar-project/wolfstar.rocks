APIThreadOnlyChannel | API | discord-api-types documentation
...
### [__](#default_sort_order) __default_sort_order

__default_sort_order: null | SortOrderType

The default sort order type used to order posts in a thread-only channel

### [__](#default_thread_rate_limit_per_user) __optionaldefault_thread_rate_limit_per_user
...
Inherited from APIGuildChannel.flags

### [__](#guild_id) __optionalinheritedguild_id

__guild_id?: string

Inherited from APIGuildChannel.guild_id
...
Inherited from APIGuildChannel.id

The id of the channel

### [__](#last_message_id) __optionallast_message_id
...
### [__](#last_pin_timestamp) __optionallast_pin_timestamp
...
Inherited from APIGuildChannel.name
...
Inherited from APIGuildChannel.nsfw
...
Inherited from APIGuildChannel.parent_id
...
Inherited from APIGuildChannel.permission_overwrites
...
Inherited from APISortableChannel.position

Sorting position of the channel

### [__](#rate_limit_per_user) __optionalrate_limit_per_user
...
Inherited from APIGuildChannel.type
...
Previous APIThreadMetadata Next APIThumbnailComponent

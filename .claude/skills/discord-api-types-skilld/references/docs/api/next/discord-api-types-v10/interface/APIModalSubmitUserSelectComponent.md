APIModalSubmitUserSelectComponent | API | discord-api-types documentation
...
- APIBaseModalSubmitComponent<ComponentType.UserSelect>
  - _APIModalSubmitUserSelectComponent_
...
Previous APIModalSubmitTextInputComponent Next APINameableChannel

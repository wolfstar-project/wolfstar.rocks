APIModalInteractionResponseCallbackData | API | discord-api-types documentation
...
__components: APIModalInteractionResponseCallbackComponent[]
...
Previous APIModalInteractionResponse Next APIModalSubmission

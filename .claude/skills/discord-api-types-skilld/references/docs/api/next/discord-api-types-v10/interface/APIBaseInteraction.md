APIBaseInteraction | API | discord-api-types documentation
...
- [__app_permissions](#app_permissions)
- [__application_id](#application_id)
- [__attachment_size_limit](#attachment_size_limit)
...
### [__](#app_permissions) __app_permissions

__app_permissions: string
...
### [__](#attachment_size_limit) __attachment_size_limit

__attachment_size_limit: number

Attachment size limit in bytes

### [__](#authorizing_integration_owners) __authorizing_integration_owners

__authorizing_integration_owners: APIAuthorizingIntegrationOwnersMap

Mapping of installation contexts that the interaction was authorized for to related user or guild IDs.

### [__](#channel) __optionalchannel

__channel?: Partial<APIChannel> & Pick<APIChannel, "id" | "type">

The channel it was sent from

### [__](#channel_id) __optionalchannel_id
...
### [__](#context) __optionalcontext

__context?: InteractionContextType

Context where the interaction was triggered from

### [__](#data) __optionaldata

__data?: Data

The command data payload

### [__](#entitlements) __entitlements

__entitlements: APIEntitlement[]

For monetized apps, any entitlements for the invoking user, representing access to premium SKUs

### [__](#guild) __optionalguild

__guild?: APIPartialInteractionGuild
...
### [__](#guild_locale) __optionalguild_locale

__guild_locale?: Locale
...
### [__](#member) __optionalmember

__member?: APIInteractionGuildMember

Guild member data for the invoking user, including permissions

**This is only sent when an interaction is invoked in a guild**

### [__](#message) __optionalmessage
...
Previous APIBaseGuildMember Next APIBaseInteractionMetadata

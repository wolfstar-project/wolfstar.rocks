GatewayGuildMemberAddDispatchData | API | discord-api-types documentation
...
- APIGuildMember
  - _GatewayGuildMemberAddDispatchData_
...
- [__avatar](#avatar)
- [__avatar_decoration_data](#avatar_decoration_data)
- [__banner](#banner)
- [__collectibles](#collectibles)
- [__communication_disabled_until](#communication_disabled_until)
- [__deaf](#deaf)
- [__flags](#flags)
- [__guild_id](#guild_id)
- [__joined_at](#joined_at)
- [__mute](#mute)
- [__nick](#nick)
- [__pending](#pending)
- [__premium_since](#premium_since)
- [__roles](#roles)
- [__user](#user)

## Properties [__](#Properties)

### [__](#avatar) __optionalinheritedavatar

__avatar?: null |string

Inherited from APIGuildMember.avatar

The member's guild avatar hash

### [__](#avatar_decoration_data) __optionalinheritedavatar_decoration_data

__avatar_decoration_data?: null | APIAvatarDecorationData

Inherited from APIGuildMember.avatar_decoration_data
...
### [__](#banner) __optionalinheritedbanner

__banner?: null |string

Inherited from APIGuildMember.banner

The member's guild banner hash

### [__](#collectibles) __optionalinheritedcollectibles

__collectibles?: null | APICollectibles

Inherited from APIGuildMember.collectibles
...
### [__](#communication_disabled_until) __optionalinheritedcommunication_disabled_until

__communication_disabled_until?: null |string

Inherited from APIGuildMember.communication_disabled_until

Timestamp of when the time out will be removed; until then, they cannot interact with the guild

### [__](#deaf) __inheriteddeaf

__deaf: boolean

Inherited from APIGuildMember.deaf

Whether the user is deafened in voice channels

### [__](#flags) __inheritedflags

__flags: GuildMemberFlags

Inherited from APIGuildMember.flags
...
### [__](#guild_id) __guild_id

__guild_id: string

The id of the guild

### [__](#joined_at) __inheritedjoined_at

__joined_at: null |string

Inherited from APIGuildMember.joined_at

When the user joined the guild

### [__](#mute) __inheritedmute

__mute: boolean

Inherited from APIGuildMember.mute

Whether the user is muted in voice channels

### [__](#nick) __optionalinheritednick

__nick?: null |string

Inherited from APIGuildMember.nick

This users guild nickname

### [__](#pending) __optionalinheritedpending

__pending?: boolean

Inherited from APIGuildMember.pending
...
### [__](#premium_since) __optionalinheritedpremium_since

__premium_since?: null |string

Inherited from APIGuildMember.premium_since
...
https://support.discord.com/hc/articles/360028038352

</dd></dl>

### [__](#roles) __inheritedroles

__roles: string[]

Inherited from APIGuildMember.roles
...
### [__](#user) __inheriteduser

__user: APIUser

Inherited from APIGuildMember.user
...
Previous GatewayGuildIntegrationsUpdateDispatchData Next GatewayGuildMemberRemoveDispatchData

...
- Remove `autoplay` attribute from audio/video tags (#59)
- Exclude fetching scripts that use `<link rel="modulepreload">` (#52)
...
- More robust `rootShadowHost` check (#50)
- Fix duplicated textarea value (#62)
- Handle removed attributes (#65)

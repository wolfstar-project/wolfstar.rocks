...
Playwright makes this easy. Just pin
...
WebdriverIO expects you to bring
your own browsers. The folks at
@browser-actions have your back:
...
1. **Enable token authentication**: enable access tokens for your workspace, then generate a token and set it as the `PLAYWRIGHT_SERVICE_ACCESS_TOKEN` environment variable.

GatewayHelloData | API | discord-api-types documentation
...
- [__heartbeat_interval](#heartbeat_interval)

## Properties [__](#Properties)

### [__](#heartbeat_interval) __heartbeat_interval

__heartbeat_interval: number

The interval (in milliseconds) the client should heartbeat with

Previous GatewayHello Next GatewayIdentify

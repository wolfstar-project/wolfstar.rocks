APIApplicationCommandSubcommandGroupOption | API | discord-api-types documentation
...
- APIApplicationCommandOptionBase<ApplicationCommandOptionType.SubcommandGroup>
  - _APIApplicationCommandSubcommandGroupOption_
...
### [__](#description) __inheriteddescription

__description: string

Inherited from APIApplicationCommandOptionBase.description

### [__](#description_localizations) __optionalinheriteddescription_localizations

__description_localizations?: null |Partial<Record< Locale,null |string>>

Inherited from APIApplicationCommandOptionBase.description_localizations

### [__](#name) __inheritedname

__name: string

Inherited from APIApplicationCommandOptionBase.name

### [__](#name_localizations) __optionalinheritedname_localizations

__name_localizations?: null |Partial<Record< Locale,null |string>>

Inherited from APIApplicationCommandOptionBase.name_localizations

### [__](#options) __optionaloptions

__options?: APIApplicationCommandSubcommandOption[]

### [__](#required) __optionalinheritedrequired

__required?: boolean

Inherited from APIApplicationCommandOptionBase.required

### [__](#type) __inheritedtype

__type: SubcommandGroup

Inherited from APIApplicationCommandOptionBase.type

Previous APIApplicationCommandStringOptionBase Next APIApplicationCommandSubcommandOption

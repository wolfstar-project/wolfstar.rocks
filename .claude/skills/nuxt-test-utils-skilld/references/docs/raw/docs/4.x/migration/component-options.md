...
In Nuxt 3 you can use a globally available `fetch` method that has the same API as the Fetch API or [`$fetch`](/docs/4.x/api/utils/dollarfetch) method which is using unjs/ofetch. It has a number of benefits, including:

...
Internally, Nuxt uses `@nuxt/schema` to define these experimental features. You can refer to the [API documentation](/docs/4.x/guide/going-further/experimental-features) or the source code for more information.
...
Enable Vite 6's new Environment API for improved build configuration and plugin architecture.

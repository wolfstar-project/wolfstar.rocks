APITeam | API | discord-api-types documentation
...
### [__](#owner_user_id) __owner_user_id

__owner_user_id: string

The user id of the current team owner

Previous APISubscription Next APITeamMember

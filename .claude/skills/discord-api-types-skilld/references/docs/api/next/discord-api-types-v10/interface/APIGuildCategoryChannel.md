APIGuildCategoryChannel | API | discord-api-types documentation
...
- APIGuildChannel<ChannelType.GuildCategory>
- APISortableChannel
  - _APIGuildCategoryChannel_
...
### [__](#parent_id) __optionalparent_id

__parent_id?: null

Overrides APIGuildChannel.parent_id
...
Previous APIGuildApplicationCommandPermissions Next APIGuildChannel

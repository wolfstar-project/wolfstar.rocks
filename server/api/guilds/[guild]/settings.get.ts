...
defineRouteMeta({
	openAPI: {
		...
		parameters: [
			...
			{
				description:
					"Whether to serialize the settings data for API response (default: false)",
				in: "query",
					...
					"application/json": {
						...
						schema: {
							...
							properties: {
								// Base configuration
								id: {
									description: "Guild snowflake ID (primary key)",
									type: "string",
								},
								...
								disableNaturalPrefix: {
									description: "Disable natural language prefix",
									type: "boolean",
								},
								disabledCommands: {
								...
								permissionsUsers: {
									description:
										"PermissionNodeEntries - User permission overrides",
									items: { type: "object" },
									type: "array",
								},
								permissionsRoles: {
									description:
										"PermissionNodeEntries - Role permission overrides",
									items: { type: "object" },
									type: "array",
								},
								...
								channelsMediaOnly: {
									description: "Channels that only allow media",
									items: { type: "string" },
									type: "array",
								},
								channelsLogsModeration: {
									description: "Moderation log channel ID",
									type: ["string", "null"],
								},
								channelsLogsImage: {
									description: "Image log channel ID",
									type: ["string", "null"],
								},
								channelsLogsMemberAdd: {
									description: "Member join log channel ID",
									type: ["string", "null"],
								},
								channelsLogsMemberRemove: {
									description: "Member leave log channel ID",
									type: ["string", "null"],
								},
								channelsLogsMemberNicknameUpdate: {
									description: "Nickname update log channel ID",
									type: ["string", "null"],
								},
								channelsLogsMemberUsernameUpdate: {
									description: "Username update log channel ID",
									type: ["string", "null"],
								},
								channelsLogsMemberRolesUpdate: {
									description: "Role update log channel ID",
									type: ["string", "null"],
								},
								channelsLogsMessageDelete: {
									description: "Message delete log channel ID",
									type: ["string", "null"],
								},
								channelsLogsMessageDeleteNsfw: {
									description: "NSFW message delete log channel ID",
									type: ["string", "null"],
								},
								channelsLogsMessageUpdate: {
									description: "Message edit log channel ID",
									type: ["string", "null"],
								},
								channelsLogsMessageUpdateNsfw: {
									description: "NSFW message edit log channel ID",
									type: ["string", "null"],
								},
								channelsLogsPrune: {
									description: "Prune log channel ID",
									type: ["string", "null"],
								},
								channelsLogsReaction: {
									description: "Reaction log channel ID",
									type: ["string", "null"],
								},
								channelsLogsRoleCreate: {
									description: "Role create log channel ID",
									type: ["string", "null"],
								},
								...
								channelsLogsRoleDelete: {
									description: "Role delete log channel ID",
									type: ["string", "null"],
								},
								channelsLogsChannelCreate: {
									description: "Channel create log channel ID",
									type: ["string", "null"],
								},
								channelsLogsChannelUpdate: {
									description: "Channel update log channel ID",
									type: ["string", "null"],
								},
								channelsLogsChannelDelete: {
									description: "Channel delete log channel ID",
									type: ["string", "null"],
								},
								channelsLogsEmojiCreate: {
									description: "Emoji create log channel ID",
									type: ["string", "null"],
								},
								channelsLogsEmojiUpdate: {
									description: "Emoji update log channel ID",
									type: ["string", "null"],
								},
								channelsLogsEmojiDelete: {
									description: "Emoji delete log channel ID",
									type: ["string", "null"],
								},
								channelsLogsServerUpdate: {
									description: "Server update log channel ID",
									type: ["string", "null"],
								},
								channelsLogsVoiceChannel: {
									description: "Voice activity log channel ID",
									type: ["string", "null"],
								},
								channelsIgnoreAll: {
									description: "Channels ignored for all logging",
									items: { type: "string" },
									type: "array",
								},
								...
								commandAutoDelete: {
									description:
										"CommandAutoDeleteEntries - Auto-delete command responses",
									items: { type: "object" },
									type: "array",
								},
								disabledChannels: {
									description: "Channels where bot is disabled",
									items: { type: "string" },
									type: "array",
								},
								disabledCommandsChannels: {
									description:
										"DisabledCommandChannelEntries - Per-channel disabled commands",
									items: { type: "object" },
									type: "array",
								},
								...
								// Events
								eventsBanAdd: {
									description: "Log ban add events",
									type: "boolean",
								},
								eventsBanRemove: {
									description: "Log ban remove events",
									type: "boolean",
								},
								eventsTwemojiReactions: {
									description: "Enable twemoji reactions",
									type: "boolean",
								},
								eventsUnknownMessages: {
									description: "Log unknown message events",
									type: "boolean",
								},
								eventsIncludeBots: {
									description: "Include bots in event logging",
									type: "boolean",
								},
								eventsTimeout: {
									description: "Log timeout events",
									type: "boolean",
								},
								...
								messagesModerationDm: {
									description: "DM users on moderation action",
									type: "boolean",
								},
								messagesModerationReasonDisplay: {
									description: "Display moderation reason",
									type: "boolean",
								},
								messagesModerationMessageDisplay: {
									description: "Display moderation message",
									type: "boolean",
								},
								messagesModerationAutoDelete: {
									description: "Auto-delete moderation messages",
									type: "boolean",
								},
								messagesModeratorNameDisplay: {
									description: "Display moderator name",
									type: "boolean",
								},
								messagesAutoDeleteIgnoredAll: {
									description: "Ignore all auto-delete",
									type: "boolean",
								},
								...
								stickyRoles: {
									description:
										"StickyRoleEntries - Roles that persist after rejoin",
									items: { type: "object" },
									type: "array",
								},
								reactionRoles: {
									description:
										"ReactionRoleEntries - Reaction role configurations",
									items: { type: "object" },
									type: "array",
								},
								rolesAdmin: {
								...
								rolesInitial: {
									description: "Initial role for all members",
									type: "string",
								},
								rolesInitialHumans: {
									description: "Initial role for human members",
									type: "string",
								},
								rolesInitialBots: {
									description: "Initial role for bot members",
									type: "string",
								},
								rolesModerator: {
									description: "Moderator role IDs",
									items: { type: "string" },
									type: "array",
								},
								rolesMuted: { description: "Muted role ID", type: "string" },
								rolesRestrictedReaction: {
									description: "Reaction restricted role ID",
									type: "string",
								},
								rolesRestrictedEmbed: {
									description: "Embed restricted role ID",
									type: "string",
								},
								rolesRestrictedEmoji: {
									description: "Emoji restricted role ID",
									type: "string",
								},
								rolesRestrictedAttachment: {
									description: "Attachment restricted role ID",
									type: "string",
								},
								rolesRestrictedVoice: {
									description: "Voice restricted role ID",
									type: "string",
								},
								rolesPublic: {
									description: "Public self-assignable role IDs",
									items: { type: "string" },
									type: "array",
								},
								rolesRemoveInitial: {
									description:
										"Remove initial role when other roles are assigned",
									type: "boolean",
								},
								rolesUniqueRoleSets: {
									description:
										"UniqueRoleSetEntries - Mutually exclusive role sets",
									items: { type: "object" },
									type: "array",
								},
								...
								selfmodAttachmentsEnabled: {
									description: "Enable attachment spam protection",
									type: "boolean",
								},
								...
								selfmodAttachmentsSoftAction: {
									description: "Soft action for attachments (bitmask)",
									type: "integer",
								},
								selfmodAttachmentsHardAction: {
									description: "Hard action for attachments (bitmask)",
									type: "integer",
								},
								selfmodAttachmentsHardActionDuration: {
									description: "Duration for hard action in ms",
									type: "integer",
								},
								selfmodAttachmentsThresholdMaximum: {
									description: "Maximum attachments before action",
									type: "integer",
								},
								selfmodAttachmentsThresholdDuration: {
									description: "Time window for threshold in ms",
									type: "integer",
								},

								// Self-moderation: Capitals
								selfmodCapitalsEnabled: {
									description: "Enable capitals spam protection",
									type: "boolean",
								},
								...
								selfmodCapitalsMinimum: {
									description: "Minimum message length to check",
									type: "integer",
								},
								selfmodCapitalsMaximum: {
									description: "Maximum percentage of capitals allowed",
									type: "integer",
								},
								selfmodCapitalsSoftAction: {
									description: "Soft action for capitals (bitmask)",
									type: "integer",
								},
								selfmodCapitalsHardAction: {
									description: "Hard action for capitals (bitmask)",
									type: "integer",
								},
								...
								selfmodLinksEnabled: {
									description: "Enable link spam protection",
									type: "boolean",
								},
								selfmodLinksAllowed: {
								...
								selfmodLinksIgnoredRoles: {
									description: "Roles ignored for link filter",
									items: { type: "string" },
									type: "array",
								},
								...
								selfmodLinksSoftAction: {
									description: "Soft action for links (bitmask)",
									type: "integer",
								},
								selfmodLinksHardAction: {
									description: "Hard action for links (bitmask)",
									type: "integer",
								},
								...
								selfmodLinksThresholdMaximum: {
									description: "Maximum links before action",
									type: "integer",
								},
								...
								selfmodMessagesEnabled: {
									description: "Enable duplicate message protection",
									type: "boolean",
								},
								...
								selfmodMessagesMaximum: {
									description: "Maximum duplicate messages allowed",
									type: "integer",
								},
								selfmodMessagesQueueSize: {
									description: "Message queue size for comparison",
									type: "integer",
								},
								selfmodMessagesSoftAction: {
									description: "Soft action for duplicates (bitmask)",
									type: "integer",
								},
								selfmodMessagesHardAction: {
									description: "Hard action for duplicates (bitmask)",
									type: "integer",
								},
								...
								selfmodNewlinesEnabled: {
									description: "Enable newline spam protection",
									type: "boolean",
								},
								...
								selfmodNewlinesMaximum: {
									description: "Maximum newlines allowed per message",
									type: "integer",
								},
								selfmodNewlinesSoftAction: {
									description: "Soft action for newlines (bitmask)",
									type: "integer",
								},
								selfmodNewlinesHardAction: {
									description: "Hard action for newlines (bitmask)",
									type: "integer",
								},
								...
								selfmodInvitesEnabled: {
									description: "Enable invite link protection",
									type: "boolean",
								},
								selfmodInvitesIgnoredCodes: {
									description: "Allowed invite codes",
									items: { type: "string" },
									type: "array",
								},
								...
								selfmodInvitesSoftAction: {
									description: "Soft action for invites (bitmask)",
									type: "integer",
								},
								selfmodInvitesHardAction: {
									description: "Hard action for invites (bitmask)",
									type: "integer",
								},
								...
								selfmodInvitesThresholdMaximum: {
									description: "Maximum invites before action",
									type: "integer",
								},
								...
								selfmodFilterEnabled: {
									description: "Enable word filter protection",
									type: "boolean",
								},
								selfmodFilterRaw: {
								...
								selfmodFilterIgnoredRoles: {
									description: "Roles ignored for word filter",
									items: { type: "string" },
									type: "array",
								},
								...
								selfmodFilterSoftAction: {
									description: "Soft action for filter (bitmask)",
									type: "integer",
								},
								selfmodFilterHardAction: {
									description: "Hard action for filter (bitmask)",
									type: "integer",
								},
								...
								selfmodFilterThresholdMaximum: {
									description: "Maximum filter hits before action",
									type: "integer",
								},
								...
								selfmodReactionsEnabled: {
									description: "Enable reaction spam protection",
									type: "boolean",
								},
								...
								selfmodReactionsAllowed: {
									description: "Allowed reaction emojis",
									items: { type: "string" },
									type: "array",
								},
								selfmodReactionsBlocked: {
									description: "Blocked reaction emojis",
									items: { type: "string" },
									type: "array",
								},
								selfmodReactionsSoftAction: {
									description: "Soft action for reactions (bitmask)",
									type: "integer",
								},
								selfmodReactionsHardAction: {
									description: "Hard action for reactions (bitmask)",
									type: "integer",
								},
								...
								selfmodIgnoredChannels: {
									description: "Channels ignored for all selfmod",
									items: { type: "string" },
									type: "array",
								},
								...
								noMentionSpamEnabled: {
									description: "Enable mention spam protection",
									type: "boolean",
								},
								noMentionSpamAlerts: {
									description: "Send alerts for mention spam",
									type: "boolean",
								},
								noMentionSpamMentionsAllowed: {
									description: "Maximum mentions allowed",
									type: "integer",
								},
								noMentionSpamTimePeriod: {
									description: "Time period for mention limit in seconds",
									type: "integer",
								},
							},
							type: "object",

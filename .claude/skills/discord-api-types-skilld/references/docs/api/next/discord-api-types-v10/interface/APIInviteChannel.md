APIInviteChannel | API | discord-api-types documentation
...
Inherited from Required.name

The name of the channel (1-100 characters)

### [__](#recipients) __optionalrecipients

__recipients?: Pick< APIUser,username>[]
...
Previous APIInvite Next APIInviteStageInstance

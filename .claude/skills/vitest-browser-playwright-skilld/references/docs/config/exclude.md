...
A list of glob patterns that should be excluded from your test files. These patterns are resolved relative to the [`root`](/config/root) (`process.cwd()` by default).

APIDMChannel | API | discord-api-types documentation
...
- APIDMChannelBase<ChannelType.DM>
  - _APIDMChannel_
...
Inherited from APIDMChannelBase.last_message_id
...
Previous APIContainerComponent Next APIDMChannelBase

APIGuildMember | API | discord-api-types documentation
...
Inherited from APIGuildMemberAvatar.avatar
...
Inherited from APIGuildMemberAvatar.banner
...
Inherited from APIBaseVoiceGuildMember.deaf
...
Inherited from APIFlaggedGuildMember.flags
...
Inherited from APIBaseVoiceGuildMember.mute
...
Inherited from APIGuildMemberUser.user
...
Previous APIGuildIntegrationApplication Next APIGuildMemberAvatar

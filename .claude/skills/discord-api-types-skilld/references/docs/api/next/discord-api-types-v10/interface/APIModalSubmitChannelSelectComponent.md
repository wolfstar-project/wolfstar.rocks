APIModalSubmitChannelSelectComponent | API | discord-api-types documentation
...
- APIBaseModalSubmitComponent<ComponentType.ChannelSelect>
  - _APIModalSubmitChannelSelectComponent_
...
Previous APIModalSubmission Next APIModalSubmitCheckboxComponent

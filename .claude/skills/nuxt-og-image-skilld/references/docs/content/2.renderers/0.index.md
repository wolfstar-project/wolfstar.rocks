...
All renderers share core features: Tailwind CSS support, custom fonts (Google Fonts, local, variable, WOFF2), emoji rendering, and edge runtime compatibility.
...
|-------------|--------|--------|----------|
| Node.js |  |  `@takumi-rs/core` |  `playwright-core` |

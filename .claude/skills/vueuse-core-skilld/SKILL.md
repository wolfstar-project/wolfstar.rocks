...
Use `pnpm exec skilld search "query" -p @vueuse/core` instead of grepping `.skilld/` directories. Run `pnpm exec skilld search --guide -p @vueuse/core` for full syntax, filters, and operators.

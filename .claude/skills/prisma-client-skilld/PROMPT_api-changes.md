...
Search: `skilld search "deprecated" -p @prisma/client`, `skilld search "breaking" -p @prisma/client`, `skilld search "v7.7" -p @prisma/client`, `skilld search "v7.6" -p @prisma/client`, `skilld search "v7.5" -p @prisma/client`, `skilld search "Features" -p @prisma/client`
...
| Change type | v7.x | v6.x → v7.x migration | Older |
|-------------|:---:|:---:|:---:|
...
The "Older" column means ≤ v5.x — these changes are NOT useful because anyone on v7.x already migrated past them.

...
This composable didn't do anything in v4 as Nuxt enables the robots meta tag by default. If you'd like to control the robot meta tag rule, use the [`useRobotsRule()`{lang="ts"}](/docs/robots/api/use-robots-rule) composable.

APIApplicationCommandInteractionDataIntegerOption | API | discord-api-types documentation
...
- APIInteractionDataOptionBase<ApplicationCommandOptionType.Integer,Type extendsInteractionType.ApplicationCommandAutocomplete ?string :number>
  - _APIApplicationCommandInteractionDataIntegerOption_
...
Previous APIApplicationCommandIntegerOptionBase Next APIApplicationCommandInteractionDataNumberOption

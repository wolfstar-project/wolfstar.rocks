...
Inside your webview2 control, you can just right-click to open the context menu and select "Inspect" to open the DevTools or press <kbd>F12</kbd>. You can also use the WebView2.CoreWebView2.OpenDevToolsWindow method to open the DevTools programmatically.

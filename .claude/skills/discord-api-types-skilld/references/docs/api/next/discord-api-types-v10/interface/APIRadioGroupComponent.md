APIRadioGroupComponent | API | discord-api-types documentation
...
- APIBaseComponent<ComponentType.RadioGroup>
  - _APIRadioGroupComponent_
...
Previous APIPremiumRequiredInteractionResponse Next APIRadioGroupOption

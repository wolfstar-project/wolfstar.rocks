APIApplicationCommandPermission | API | discord-api-types documentation
...
### [__](#permission) __permission

__permission: boolean

`true` to allow, `false`, to disallow

### [__](#type) __type

__type: ApplicationCommandPermissionType

Role, user or channel

Previous APIApplicationCommandOptionChoice Next APIApplicationCommandStringOptionBase

APIPartialChannel | API | discord-api-types documentation
...
Inherited from APIBasePartialChannel.id

The id of the channel

### [__](#name) __optionalinheritedname

__name?: null |string

Inherited from APINameableChannel.name
...
Inherited from APIBasePartialChannel.type
...
Previous APIOverwrite Next APIPartialEmoji

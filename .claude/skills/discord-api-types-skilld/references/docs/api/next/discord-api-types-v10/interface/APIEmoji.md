APIEmoji | API | discord-api-types documentation
...
- [__managed](#managed)
- [__name](#name)
- [__require_colons](#require_colons)
- [__roles](#roles)
- [__user](#user)

## Properties [__](#Properties)

### [__](#animated) __optionalinheritedanimated

__animated?: boolean

Inherited from APIPartialEmoji.animated

Whether this emoji is animated

### [__](#available) __optionalavailable
...
Inherited from APIPartialEmoji.id
...
Inherited from APIPartialEmoji.name

Emoji name (can be null only in reaction emoji objects)

### [__](#require_colons) __optionalrequire_colons

__require_colons?: boolean

Whether this emoji must be wrapped in colons

### [__](#roles) __optionalroles
...
Previous APIEmbedVideo Next APIEntitlement

...
Use the `autoImport` option to disable composable auto-imports or to customize `unplugin-auto-import` options.
...
Use the `components` option to disable component auto-imports or to customize `unplugin-vue-components` options.

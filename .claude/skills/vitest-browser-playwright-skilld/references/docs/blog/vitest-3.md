...
Vitest 3 is the result of countless hours by the [Vitest team](/team) and our contributors. We appreciate the individuals and companies sponsoring Vitest development. Vladimir and Hiroshi joined VoidZero to work on Vite and Vitest full-time, and StackBlitz hired Ari to invest more time in Vitest development. A shout-out to NuxtLabs, Zammad, and sponsors on Vitest's GitHub Sponsors and Vitest's Open Collective.

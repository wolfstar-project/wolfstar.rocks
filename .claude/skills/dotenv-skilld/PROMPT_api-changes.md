...
|-----------|------|:-----:|--------|
| Changelog | [`CHANGELOG.md`./references/pkg/CHANGELOG.md) | 9/10 | Features/Breaking Changes sections per version |
...
Search: `skilld search "deprecated" -p dotenv`, `skilld search "breaking" -p dotenv`, `skilld search "v17.4" -p dotenv`, `skilld search "v17.3" -p dotenv`, `skilld search "v17.2" -p dotenv`, `skilld search "Features" -p dotenv`

**Item scoring** — include only items scoring ≥ 3. Items scoring 0 MUST be excluded:

| Change type | v17.x | v16.x → v17.x migration | Older |
|-------------|:---:|:---:|:---:|
...
The "Older" column means ≤ v15.x — these changes are NOT useful because anyone on v17.x already migrated past them.
...
- Scan CHANGELOG.md for version headings, focus on Features/Breaking Changes sections

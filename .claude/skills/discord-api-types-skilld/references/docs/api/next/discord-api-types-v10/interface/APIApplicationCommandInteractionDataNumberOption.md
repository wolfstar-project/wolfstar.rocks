APIApplicationCommandInteractionDataNumberOption | API | discord-api-types documentation
...
- APIInteractionDataOptionBase<ApplicationCommandOptionType.Number,Type extendsInteractionType.ApplicationCommandAutocomplete ?string :number>
  - _APIApplicationCommandInteractionDataNumberOption_
...
Inherited from APIInteractionDataOptionBase.name

### [__](#type) __inheritedtype

__type: Number

Inherited from APIInteractionDataOptionBase.type

### [__](#value) __inheritedvalue

__value: Type extendsApplicationCommandAutocomplete ?string :number

Inherited from APIInteractionDataOptionBase.value

Previous APIApplicationCommandInteractionDataIntegerOption Next APIApplicationCommandInteractionDataStringOption

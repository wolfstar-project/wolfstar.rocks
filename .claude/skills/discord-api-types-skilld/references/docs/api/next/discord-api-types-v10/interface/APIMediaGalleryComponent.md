APIMediaGalleryComponent | API | discord-api-types documentation
...
- APIBaseComponent<ComponentType.MediaGallery>
  - _APIMediaGalleryComponent_
...
Previous APILabelComponent Next APIMediaGalleryItem

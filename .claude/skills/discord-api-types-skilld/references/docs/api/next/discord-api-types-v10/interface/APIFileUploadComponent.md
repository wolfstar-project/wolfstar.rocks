APIFileUploadComponent | API | discord-api-types documentation
...
- APIBaseComponent<ComponentType.FileUpload>
  - _APIFileUploadComponent_
...
Previous APIFileComponent Next APIFlaggedGuildMember

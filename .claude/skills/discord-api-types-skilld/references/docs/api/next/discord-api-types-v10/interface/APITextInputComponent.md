APITextInputComponent | API | discord-api-types documentation
...
- APIBaseComponent<ComponentType.TextInput>
  - _APITextInputComponent_
...
### [__](#value) __optionalvalue

__value?: string

The pre-filled text in the text input

Previous APITextDisplayComponent Next APIThreadChannel

...
![screenshot of create nuxt app](/assets/blog/create-nuxt-ascii.jpeg)

Special thanks to @cmang for the beautiful ASCII-art. 
...
<read-more icon="i-simple-icons-github" target="_blank" to="https://github.com/nuxt/nuxt/releases/tag/v3.16.0">

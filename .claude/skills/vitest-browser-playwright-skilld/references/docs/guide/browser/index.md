...
WebdriverIO allows you to run tests locally using the WebDriver protocol.
...
- `vitest-browser-angular` to render Angular components
...
Besides rendering components and locating elements, you will also need to make assertions. Vitest forks the `@testing-library/jest-dom` library to provide a wide range of DOM assertions out of the box. Read more at the [Assertions API](/api/browser/assertions).

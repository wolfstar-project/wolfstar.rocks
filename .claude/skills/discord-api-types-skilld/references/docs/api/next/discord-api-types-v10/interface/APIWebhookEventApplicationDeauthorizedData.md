APIWebhookEventApplicationDeauthorizedData | API | discord-api-types documentation
...
Previous APIWebhookEventApplicationAuthorizedData Next APIWebhookEventBase

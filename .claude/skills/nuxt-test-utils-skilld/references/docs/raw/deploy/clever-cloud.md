...
If `ssr: false` is set in `nuxt.config.ts` **or** if your project contains dynamic routes that cannot be pre-rendered, you should :

1. Use a **Static Apache** application
2. Create a `.htaccess` file that redirects all routes to `index.html` to ensure proper routing for your SPA.
...
2. **Deploy!** If you’re deploying from **GitHub**, your deployment should start automatically. If you’re using **Git**, show this docs.

## Learn more

<read-more target="_blank" to="https://developers.clever-cloud.com/guides/nuxt">

...
Vitest Browser Mode supports generating Playwright's trace files. To enable tracing, you need to set the [`trace`](/config/browser/trace) option in the `test.browser` configuration.

APIVoiceState | API | discord-api-types documentation
...
- [__member](#member)
- [__mute](#mute)
- [__request_to_speak_timestamp](#request_to_speak_timestamp)
- [__self_deaf](#self_deaf)
- [__self_mute](#self_mute)
- [__self_stream](#self_stream)
- [__self_video](#self_video)
...
### [__](#channel_id) __inheritedchannel_id

__channel_id: null |string

Inherited from APIBaseVoiceState.channel_id
...
Inherited from APIBaseVoiceState.deaf
...
### [__](#member) __optionalinheritedmember

__member?: APIGuildMember

Inherited from APIBaseVoiceState.member
...
Inherited from APIBaseVoiceState.mute

Whether this user is muted by the server

### [__](#request_to_speak_timestamp) __inheritedrequest_to_speak_timestamp

__request_to_speak_timestamp: null |string

Inherited from APIBaseVoiceState.request_to_speak_timestamp

The time at which the user requested to speak

### [__](#self_deaf) __inheritedself_deaf

__self_deaf: boolean

Inherited from APIBaseVoiceState.self_deaf

Whether this user is locally deafened

### [__](#self_mute) __inheritedself_mute

__self_mute: boolean

Inherited from APIBaseVoiceState.self_mute

Whether this user is locally muted

### [__](#self_stream) __optionalinheritedself_stream

__self_stream?: boolean

Inherited from APIBaseVoiceState.self_stream

Whether this user is streaming using "Go Live"

### [__](#self_video) __inheritedself_video

__self_video: boolean

Inherited from APIBaseVoiceState.self_video

Whether this user's camera is enabled

### [__](#session_id) __inheritedsession_id

__session_id: string

Inherited from APIBaseVoiceState.session_id

The session id for this voice state

### [__](#suppress) __inheritedsuppress

__suppress: boolean

Inherited from APIBaseVoiceState.suppress

Whether this user is muted by the current user

### [__](#user_id) __inheriteduser_id

__user_id: string

Inherited from APIBaseVoiceState.user_id

The user id this voice state is for

Previous APIVoiceRegion Next APIWebhook

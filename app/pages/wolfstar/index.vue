<template>
    ...
    <section class="mt-32 grid gap-4 md:gap-12 lg:grid-cols-2 lg:gap-20">
        ...
        <discord-messages class="w-full">
          ...
          >
            <template v-if="featureIndex === AutomodFeature.Attachments">
              ...
              <div class="grid max-w-96 grid-cols-2 gap-2">
                <div class="flex aspect-video w-full items-center justify-center rounded-lg bg-base-100 drop-shadow-lg">
                  <UIcon name="ph:image-duotone" class="h-24 w-24 animate-pulse text-base-content/20" />
                </div>
                <div class="flex aspect-video w-full items-center justify-center rounded-lg bg-base-100 drop-shadow-lg">
                  <UIcon name="ph:image-duotone" class="h-24 w-24 animate-pulse text-base-content/20" />
                </div>
            ...
            <template v-else-if="featureIndex === AutomodFeature.Reactions">
              ...
              <discord-reactions>
                <discord-reaction :count="7" self><UIcon name="ph:cheers-fill" class="text-success" /></discord-reaction>
                <discord-reaction :count="1" class="text-error"><UIcon name="ph:knife-fill" /></discord-reaction>
              </discord-reactions>
            </template>
      ...
      <div class="prose">
        ...
        <ul>
          ...
          <li>
            <UIcon name="ph:trash-simple-fill" class="my-0 mr-1 h-5 w-5 text-error" />
        ...
        <ul>
          <li>
            <UIcon name="ph:shield-check-duotone" class="my-0 mr-1 h-5 w-5 text-purple-500" />
  ...
  <ClientOnly>
    <section class="mt-32 grid gap-4 md:gap-12 lg:grid-cols-2 lg:gap-20">
      <div class="prose">
        ...
        <p>
          <UIcon name="ph:binoculars-duotone" class="my-0 mr-1 h-5 w-5 text-purple-500" />
      ...
      <div class="flex flex-col items-center gap-4 lg:flex-row">
        ...
        <div class="flex flex-col items-start">
          ...
          <div class="mt-4 join self-start">
            ...
            >
              <UIcon name="ph:arrow-counter-clockwise-duotone" class="my-0 mr-1 h-5 w-5" />
              Undo
            </button>
          </div>
        </div>
  ...
  <section class="prose">
    ...
    <ul>
      ...
      <li>
        <UIcon name="ph:money-wavy-duotone" class="my-0 mr-1 h-5 w-5 text-error" />

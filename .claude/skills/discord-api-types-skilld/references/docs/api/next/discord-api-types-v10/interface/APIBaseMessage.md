APIBaseMessage | API | discord-api-types documentation
...
- API v10
  ...
  - Interfaces
    ...
    - GatewayReconnect
    - GatewayRequestGuildMemberRateLimitMetadata
    ...
    - RPCAPIMessageParsedContentOriginalMatch
...
- [__content](#content)
- [__edited_timestamp](#edited_timestamp)
- [__embeds](#embeds)
- [__flags](#flags)
- [__id](#id)
- [__interaction](#interaction)
- [__interaction_metadata](#interaction_metadata)
- [__mention_channels](#mention_channels)
- [__mention_everyone](#mention_everyone)
- [__mention_roles](#mention_roles)
- [__message_reference](#message_reference)
- [__message_snapshots](#message_snapshots)
- [__nonce](#nonce)
- [__pinned](#pinned)
- [__poll](#poll)
- [__position](#position)
- [__reactions](#reactions)
- [__referenced_message](#referenced_message)
- [__resolved](#resolved)
- [__role_subscription_data](#role_subscription_data)
- [__shared_client_theme](#shared_client_theme)
- [__sticker_items](#sticker_items)
- [__stickers](#stickers)
- [__thread](#thread)
- [__timestamp](#timestamp)
- [__tts](#tts)
- [__type](#type)
- [__webhook_id](#webhook_id)

## Properties [__](#Properties)

### [__](#activity) __optionalinheritedactivity

__activity?: APIMessageActivity

Inherited from APIBaseMessageNoChannel.activity
...
### [__](#application) __optionalinheritedapplication

__application?: Partial< APIApplication>

Inherited from APIBaseMessageNoChannel.application
...
### [__](#application_id) __optionalinheritedapplication_id

__application_id?: string

Inherited from APIBaseMessageNoChannel.application_id

If the message is a response to an Interaction, this is the id of the interaction's application

### [__](#attachments) __inheritedattachments

__attachments: APIAttachment[]

Inherited from APIBaseMessageNoChannel.attachments
...
- https://support-dev.discord.com/hc/articles/6207308062871

</dd></dl>

### [__](#author) __inheritedauthor

__author: APIUser

Inherited from APIBaseMessageNoChannel.author
...
### [__](#call) __optionalinheritedcall

__call?: APIMessageCall

Inherited from APIBaseMessageNoChannel.call

The call associated with the message

### [__](#channel_id) __channel_id

__channel_id: string

ID of the channel the message was sent in

### [__](#components) __optionalinheritedcomponents

__components?: APIMessageTopLevelComponent[]

Inherited from APIBaseMessageNoChannel.components
...
### [__](#content) __inheritedcontent

__content: string

Inherited from APIBaseMessageNoChannel.content
...
### [__](#edited_timestamp) __inheritededited_timestamp

__edited_timestamp: null |string

Inherited from APIBaseMessageNoChannel.edited_timestamp

When this message was edited (or null if never)

### [__](#embeds) __inheritedembeds

__embeds: APIEmbed[]

Inherited from APIBaseMessageNoChannel.embeds
...
### [__](#flags) __optionalinheritedflags

__flags?: MessageFlags

Inherited from APIBaseMessageNoChannel.flags
...
Inherited from APIBaseMessageNoChannel.id

ID of the message

### [__](#interaction) __optionalinheritedinteraction

__interaction?: APIMessageInteraction

Inherited from APIBaseMessageNoChannel.interaction
...
### [__](#interaction_metadata) __optionalinheritedinteraction_metadata

__interaction_metadata?: APIMessageInteractionMetadata

Inherited from APIBaseMessageNoChannel.interaction_metadata

Sent if the message is sent as a result of an interaction

### [__](#mention_channels) __optionalinheritedmention_channels

__mention_channels?: APIChannelMention[]

Inherited from APIBaseMessageNoChannel.mention_channels
...
### [__](#mention_everyone) __inheritedmention_everyone

__mention_everyone: boolean

Inherited from APIBaseMessageNoChannel.mention_everyone

Whether this message mentions everyone

### [__](#mention_roles) __inheritedmention_roles

__mention_roles: string[]

Inherited from APIBaseMessageNoChannel.mention_roles
...
### [__](#message_reference) __optionalinheritedmessage_reference

__message_reference?: APIMessageReference

Inherited from APIBaseMessageNoChannel.message_reference
...
### [__](#message_snapshots) __optionalinheritedmessage_snapshots

__message_snapshots?: APIMessageSnapshot[]

Inherited from APIBaseMessageNoChannel.message_snapshots

The message associated with the message_reference. This is a minimal subset of fields in a message (e.g. author is excluded.)

### [__](#nonce) __optionalinheritednonce

__nonce?: string |number

Inherited from APIBaseMessageNoChannel.nonce
...
### [__](#pinned) __inheritedpinned

__pinned: boolean

Inherited from APIBaseMessageNoChannel.pinned

Whether this message is pinned

### [__](#poll) __optionalinheritedpoll

__poll?: APIPoll

Inherited from APIBaseMessageNoChannel.poll
...
### [__](#position) __optionalinheritedposition

__position?: number

Inherited from APIBaseMessageNoChannel.position

A generally increasing integer (there may be gaps or duplicates) that represents the approximate position of the message in a thread

It can be used to estimate the relative position of the message in a thread in company with `total_message_sent` on parent thread

### [__](#reactions) __optionalinheritedreactions

__reactions?: APIReaction[]

Inherited from APIBaseMessageNoChannel.reactions
...
### [__](#referenced_message) __optionalinheritedreferenced_message

__referenced_message?: null | APIMessage

Inherited from APIBaseMessageNoChannel.referenced_message
...
### [__](#resolved) __optionalinheritedresolved

__resolved?: APIInteractionDataResolved

Inherited from APIBaseMessageNoChannel.resolved
...
### [__](#role_subscription_data) __optionalinheritedrole_subscription_data

__role_subscription_data?: APIMessageRoleSubscriptionData

Inherited from APIBaseMessageNoChannel.role_subscription_data

Data of the role subscription purchase or renewal that prompted this `ROLE_SUBSCRIPTION_PURCHASE` message

### [__](#shared_client_theme) __optionalinheritedshared_client_theme

__shared_client_theme?: APIMessageSharedClientTheme

Inherited from APIBaseMessageNoChannel.shared_client_theme

The custom client-side theme shared via the message

### [__](#sticker_items) __optionalinheritedsticker_items

__sticker_items?: APIStickerItem[]

Inherited from APIBaseMessageNoChannel.sticker_items
...
### [__](#stickers) __optionalinheritedstickers

__stickers?: APISticker[]

Inherited from APIBaseMessageNoChannel.stickers
...
Use APIBaseMessageNoChannel.sticker_items instead

</dd></dl>

### [__](#thread) __optionalinheritedthread

__thread?: APIChannel

Inherited from APIBaseMessageNoChannel.thread

Sent if a thread was started from this message

### [__](#timestamp) __inheritedtimestamp

__timestamp: string

Inherited from APIBaseMessageNoChannel.timestamp

When this message was sent

### [__](#tts) __inheritedtts

__tts: boolean

Inherited from APIBaseMessageNoChannel.tts

Whether this was a TTS message

### [__](#type) __inheritedtype

__type: MessageType

Inherited from APIBaseMessageNoChannel.type
...
### [__](#webhook_id) __optionalinheritedwebhook_id

__webhook_id?: string

Inherited from APIBaseMessageNoChannel.webhook_id

If the message is generated by a webhook, this is the webhook's id

Previous APIBaseInteractionMetadata Next APIBaseMessageNoChannel

MessageSearchEmbedType | API | discord-api-types documentation
...
These do not correspond 1:1 to actual types and encompass a wider range of actual types.
...
Messages sent before February 24, 2026 may not be properly indexed under the `gif` embed type.
...
Previous MessageSearchAuthorType Next MessageSearchHasType

GatewayChannelPinsUpdateDispatchData | API | discord-api-types documentation
...
Previous GatewayAutoModerationActionExecutionDispatchData Next GatewayGuildAuditLogEntryCreateDispatchData

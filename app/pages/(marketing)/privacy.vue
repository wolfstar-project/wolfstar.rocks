			...
			<div class="prose prose-lg max-w-none space-y-12">
				...
				<section>
					...
					<p class="leading-relaxed text-base-content">
						...
						"Site") and various related services (collectively, the "Service(s)"). The
						Service is operated by WolfStar Project (the "Company", "we" or "us") for
						users of the Service ("you" or the "user(s)"). This privacy policy sets
						forth our policy with respect to information that is collected from visitors
						to the Site and users of the Bot and/or the Services. Under applicable law,
						WolfStar Project is the "data controller" of
						<NuxtLink
							to="https://discord.com/privacy"
							target="_blank"
							class="underline hover:opacity-70"
				...
				<section>
					...
					<p class="mb-4 leading-relaxed text-base-content">
						...
						be limited to usernames, Discord user data, or other content you send via
						the chat feature when interacting with the Bot.
					</p>
				</section>
					...
					<ul class="list-none space-y-3 pl-0 text-base-content">
						<li class="flex items-start gap-3 leading-relaxed">
							...
							<span>
								...
								connect your Discord account. It is essential for maintaining your
								authenticated session. This cookie is HTTP-only and encrypted for
								your security.
							</span>
						</li>
						<li class="flex items-start gap-3 leading-relaxed">
							...
							<span>
								...
								identifiers for error correlation and session replay. These
								identifiers are used only for debugging and are not used for
								advertising; personal data is masked where possible.
							</span>
						</li>
						<li class="flex items-start gap-3 leading-relaxed">
							<span class="shrink-0 text-base-content/50">&mdash;</span>
							<span>
								...
								infrastructure cookies required to deliver the site and are not used
				...
				<section>
					...
					<p class="leading-relaxed text-base-content">
						...
						on each visit. This information is purely functional, stored only on your
						device, and contains no personal data nor is it used to track you. We use it
						exclusively to improve your experience on our website.
					</p>
				</section>
				...
				<section>
					...
					<p class="mt-4 leading-relaxed text-base-content">
						...
						storage to correlate sessions for error reporting and session replay; these
						mechanisms are used solely for debugging and are not used for advertising.
						To opt out of session replay, contact us at
					...
					<ul class="list-none space-y-3 pl-0 text-base-content">
						...
						<li class="flex items-start gap-3 leading-relaxed">
							...
							<span>
								...
								user experience and identify compatibility issues.
							</span>
						</li>
						<li class="flex items-start gap-3 leading-relaxed">
							<span class="shrink-0 text-base-content/50">&mdash;</span>
						...
						<li class="flex items-start gap-3 leading-relaxed">
							...
							<span>
								...
								server activity to provide bot functionality and improve features.
								This data is stored securely and used only for service provision.
							</span>
						</li>
					</ul>
				</section>
				...
				<section>
					...
					<p class="leading-relaxed text-base-content">
						...
						and other countries. The laws of Germany, Italy, and other countries
						governing data collection and use may not be as comprehensive or protective
				...
				<section>
					...
					<p class="leading-relaxed text-base-content">
						...
						instance, if you contact us by email, we will use the information you
						provide to answer your question or resolve your problem. Also, if you
						provide information in order to obtain access to the Services, we will use
						your information to provide you with access to such services and to monitor
						your use of such services. The Company and its subsidiaries and affiliates
						(the “Related Companies”) may also use your information collected through
						the Services to help us improve the content and functionality of the
						Services, to better understand our users and to improve the Services. The
						Company and its affiliates may use this information to contact you in the
						future to tell you about services we believe will be of interest to you. If
						we do so, each marketing communication we send you will contain instructions
						permitting you to "opt-out" of receiving future marketing communications. In
					...
					<ul class="list-none space-y-3 pl-0 text-base-content">
						...
						<li class="flex items-start gap-3 leading-relaxed">
							...
							<span>
								...
								such functions include accessing, modifying and adding to the
								open-source source code. In order to perform these functions they
								may require samples of any of the data stored by the Services. These
								people will however never have access to the full data and any data
								will always be anonymized where required.
							</span>
						</li>
						<li class="flex items-start gap-3 leading-relaxed">
							<span class="shrink-0 text-base-content/50">&mdash;</span>
				...
				<section>
					...
					<p class="leading-relaxed text-base-content">
						...
						<NuxtLink to="mailto:contact@wolfstar.rocks">
							contact@wolfstar.rocks </NuxtLink
						>. Note: In some countries, the age of digital consent is older than 13. If
						you are in those countries, you must be at least that age to use the
						...
						engaged in that processing with such users, we will halt such processing and
						will take reasonable measures to promptly remove applicable information from
						our records.
					</p>
				</section>
				...
				<section>
					...
					<p class="leading-relaxed text-base-content">
						...
						Third Party Sites. The links from the Services do not imply that we endorse
						or have reviewed the Third Party Sites. We suggest contacting those sites
					...
					<ul class="list-none space-y-3 pl-0 text-base-content">
						...
						<li class="flex items-start gap-3 leading-relaxed">
							...
							<span>
								...
								deletion to comply with legal obligations.
							</span>
						</li>
						<li class="flex items-start gap-3 leading-relaxed">
							<span class="shrink-0 text-base-content/50">&mdash;</span>
				...
				<section>
					...
					<p class="leading-relaxed text-base-content">
						...
						secure or error free. In particular, email sent to or from the Services may
						not be secure. Therefore, you should take special care in deciding what
						information you send to us via email. Please keep this in mind when
				...
				<section>
					...
					<p class="mb-4 leading-relaxed text-base-content">
						...
						data we hold about them (including, in some cases, in portable form), and to
						obtain its correction, update, amendment or deletion in appropriate
						circumstances. They may also object to our uses or disclosures of personal
						data, to request a restriction on its processing, or withdraw any consent,
				...
				<section>
					...
					<p class="leading-relaxed text-base-content">
						...
						pursuant to Article 27 of the General Data Protection Regulation (the
						"GDPR") of the European Economic Area (the "EEA") themselves. You can
						contact the Company through aforementioned means.
					</p>
				</section>
				...
				<section>
					...
					<p class="mb-4 leading-relaxed text-base-content">
						...
						ID and profile information; internet or other network information (how you
						interact with the application, pages visited); location information (because
						your IP address may indicate your general location, but only country/region
						level); device and browser information; and other information that
					...
					<p>
						<span class="font-bold">Exercising Your Consumer Rights</span>: If you are a
						California resident, you have the right to request (1) more information
						about the categories and specific pieces of personal information we have
						collected and disclosed for a business purpose in the last 12 months, (2)
						deletion of your personal information, and (3) to opt out of sales of your
						personal information, if applicable. Details on how to make these requests
				...
				<section>
					...
					<p class="leading-relaxed text-base-content">
						...
						Privacy Policy was last updated on the date indicated above. Your continued

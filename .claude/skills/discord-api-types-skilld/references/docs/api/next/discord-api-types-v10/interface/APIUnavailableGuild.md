APIUnavailableGuild | API | discord-api-types documentation
...
### [__](#unavailable) __unavailable

__unavailable: boolean

`true` if this guild is unavailable due to an outage

Previous APIThumbnailComponent Next APIUnfurledMediaItem

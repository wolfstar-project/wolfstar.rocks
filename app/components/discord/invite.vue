<template>
	<div class="mt-2 rounded-md bg-base-200 px-2 pt-2 pb-2 drop-shadow-lg sm:px-4 sm:pb-4">
		...
		<div class="mt-2 flex">
			<div class="flex h-8 w-8 flex-none items-center justify-center overflow-hidden rounded-full select-none sm:h-12 sm:w-12">
			...
			<div class="ml-4 grow">
				...
				<div class="flex flex-row items-center">
					...
					<span class="mr-1 ml-2 inline-block h-1.5 w-1.5 rounded-full bg-base-content/80 sm:h-2 sm:w-2 md:ml-4"></span>
...
const { link, online = 0, members = 0 } = defineProps<{ link: string; online?: number; members?: number }>();
</script>

APISubscription | API | discord-api-types documentation
...
- [__canceled_at](#canceled_at)
- [__country](#country)
- [__current_period_end](#current_period_end)
- [__current_period_start](#current_period_start)
- [__entitlement_ids](#entitlement_ids)
- [__id](#id)
- [__renewal_sku_ids](#renewal_sku_ids)
- [__sku_ids](#sku_ids)
- [__status](#status)
- [__user_id](#user_id)
...
### [__](#canceled_at) __canceled_at

__canceled_at: null |string

When the subscription was canceled

### [__](#country) __optionalcountry

__country?: string

ISO3166-1 alpha-2 country code of the payment source used to purchase the subscription. Missing unless queried with a private OAuth scope.

### [__](#current_period_end) __current_period_end

__current_period_end: string

End of the current subscription period

### [__](#current_period_start) __current_period_start

__current_period_start: string

Start of the current subscription period

### [__](#entitlement_ids) __entitlement_ids

__entitlement_ids: string[]
...
### [__](#renewal_sku_ids) __renewal_sku_ids

__renewal_sku_ids: null |string[]

List of SKUs that this user will be subscribed to at renewal

### [__](#sku_ids) __sku_ids
...
Previous APIStringSelectComponent Next APITeam

...
With v8, `@sentry/node` has been completely overhauled. It is now powered by OpenTelemetry
under the hood.
...
Adjust the Node.js call for your application to use the --require
or --import parameter and point it at `instrument.js`. Using

APIInteractionGuildMember | API | discord-api-types documentation
...
Previous APIInteractionDataResolvedGuildMember Next APIInteractionResponseChannelMessageWithSource

...
Playwright can interact with the web page dialogs such as `alert`, `confirm`, `prompt` as well as `beforeunload` confirmation. For print dialogs, see [Print](#print-dialogs).

...
const sectionLabel = computed(() => {
	if (pending) return ts("common.loading");
	if (user) return ts("profile.user_profile");
	return ts("profile.guest_profile");
});
</script>

ApplicationCommandType | API | discord-api-types documentation
...
- [__ChatInput](#ChatInput)
- [__Message](#Message)
- [__PrimaryEntryPoint](#PrimaryEntryPoint)
- [__User](#User)

## Enumeration Members [__](#Enumeration Members)

### [__](#ChatInput) __ChatInput

__ChatInput: 1

Slash commands; a text-based command that shows up when a user types `/`

### [__](#Message) __Message

__Message: 3

A UI-based command that shows up when you right click or tap on a message

### [__](#PrimaryEntryPoint) __PrimaryEntryPoint

__PrimaryEntryPoint: 4
...
Previous ApplicationCommandPermissionType Next ApplicationFlags

...
The community `vitest-browser-svelte` package renders Svelte components in [Browser Mode](/guide/browser/).
...
- Svelte Testing Library documentation
- Svelte Testing Library examples

...
When you share a link of your site on social media or some chat platforms, the link will be unfurled,
displaying a title, description, and an image. All of these are powered by the Open Graph Protocol.
...
-  Render using Takumi (recommended): 2-10x faster with complete CSS support
...
-  Works on the edge: Vercel Edge, Netlify Edge and Cloudflare Workers

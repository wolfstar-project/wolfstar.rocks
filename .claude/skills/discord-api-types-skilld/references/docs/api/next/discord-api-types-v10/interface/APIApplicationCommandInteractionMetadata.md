APIApplicationCommandInteractionMetadata | API | discord-api-types documentation
...
- APIBaseInteractionMetadata<InteractionType.ApplicationCommand>
  - _APIApplicationCommandInteractionMetadata_
...
- [__target_message_id](#target_message_id)
- [__target_user](#target_user)
- [__type](#type)
- [__user](#user)
...
### [__](#target_message_id) __optionaltarget_message_id

__target_message_id?: string
...
Previous APIApplicationCommandInteractionDataSubcommandOption Next APIApplicationCommandNumberOptionBase

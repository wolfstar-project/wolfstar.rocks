...
Use `pnpm exec skilld search "query" -p @prisma/client` instead of grepping `.skilld/` directories. Run `pnpm exec skilld search --guide -p @prisma/client` for full syntax, filters, and operators.

APIApplicationInstallParams | API | discord-api-types documentation
...
Previous APIApplicationCommandSubcommandOption Next APIApplicationIntegrationTypeConfiguration

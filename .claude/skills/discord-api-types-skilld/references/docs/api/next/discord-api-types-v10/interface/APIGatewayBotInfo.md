APIGatewayBotInfo | API | discord-api-types documentation
...
- [__session_start_limit](#session_start_limit)
- [__shards](#shards)
- [__url](#url)

## Properties [__](#Properties)

### [__](#session_start_limit) __session_start_limit

__session_start_limit: APIGatewaySessionStartLimit
...
### [__](#url) __inheritedurl

__url: string

Inherited from APIGatewayInfo.url

The WSS URL that can be used for connecting to the gateway

Previous APIFollowedChannel Next APIGatewayInfo

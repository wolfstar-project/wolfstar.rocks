APIMessageInteraction | API | discord-api-types documentation
...
__member?: PartialAPIMessageInteractionGuildMember
...
Previous APIMessageComponentInteractionMetadata Next APIMessageMentionableSelectInteractionData

APIButtonComponentWithCustomId | API | discord-api-types documentation
...
- APIButtonComponentBase<ButtonStyle.Danger |ButtonStyle.Primary |ButtonStyle.Secondary |ButtonStyle.Success>
  - _APIButtonComponentWithCustomId_
...
Inherited from APIButtonComponentBase.disabled

The status of the button

### [__](#emoji) __optionalinheritedemoji

__emoji?: APIMessageComponentEmoji

Inherited from APIButtonComponentBase.emoji
...
Inherited from APIButtonComponentBase.id
...
### [__](#label) __optionalinheritedlabel

__label?: string

Inherited from APIButtonComponentBase.label

The label to be displayed on the button

### [__](#style) __inheritedstyle

__style: Primary |Secondary |Success |Danger

Inherited from APIButtonComponentBase.style
...
Inherited from APIButtonComponentBase.type

The type of the component

Previous APIButtonComponentBase Next APIButtonComponentWithSKUId

...
**References:** [package.json](./.skilld/pkg/package.json) • [Docs](./.skilld/docs/_INDEX.md) • [Issues](./.skilld/issues/_INDEX.md)

## Search

Use `skilld search "query" -p pbakaus-impeccable` instead of grepping `.skilld/` directories. Run `skilld search --guide -p pbakaus-impeccable` for full syntax, filters, and operators.

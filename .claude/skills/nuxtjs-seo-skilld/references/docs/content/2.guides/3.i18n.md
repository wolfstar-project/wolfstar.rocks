...
All Nuxt SEO modules integrate automatically with @nuxtjs/i18n and nuxt-i18n-micro. No extra configuration is needed; the integration is detected when either module is installed.

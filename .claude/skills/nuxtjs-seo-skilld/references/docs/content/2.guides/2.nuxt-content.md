...
- Using the frontmatter properties `title` and `description`, since those properties are defined by default in the schema of every "page" collection - see Standard Collection Fields for the **page** collection type)
    ```vue [[...slug].vue]

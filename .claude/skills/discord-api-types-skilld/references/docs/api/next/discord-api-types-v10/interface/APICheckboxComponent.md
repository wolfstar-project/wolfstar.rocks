APICheckboxComponent | API | discord-api-types documentation
...
- APIBaseComponent<ComponentType.Checkbox>
  - _APICheckboxComponent_
...
Previous APIChatInputApplicationCommandInteractionData Next APICheckboxGroupComponent

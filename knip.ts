	...
	workspaces: {
		".": {
			...
			ignoreDependencies: [
				...
				/** Staged for the in-progress nuxt-auth-utils -> better-auth migration; wired up in a follow-up (better-auth itself is already resolved via evlog, so only the Nuxt module needs ignoring) */

...
Use `pnpm exec skilld search "query" -p @vueuse/integrations` instead of grepping `.skilld/` directories. Run `pnpm exec skilld search --guide -p @vueuse/integrations` for full syntax, filters, and operators.

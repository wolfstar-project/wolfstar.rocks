...
Anthropic's Claude Sonnet 4.6 through the Vercel AI Gateway, with the [Nuxt MCP server](/mcp) as its grounding for docs, modules, templates, deployment guides, and GitHub issues.

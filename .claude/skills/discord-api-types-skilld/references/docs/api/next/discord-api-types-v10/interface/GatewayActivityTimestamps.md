GatewayActivityTimestamps | API | discord-api-types documentation
...
### [__](#end) __optionalend

__end?: number

Unix time (in milliseconds) of when the activity ends

### [__](#start) __optionalstart

__start?: number

Unix time (in milliseconds) of when the activity started

Previous GatewayActivitySecrets Next GatewayApplicationCommandPermissionsUpdateDispatchData

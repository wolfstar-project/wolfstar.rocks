  ...
  <div class="w-full py-10">
    ...
    >
      <template #default="{ item }">
        <div
          class="glass-card hover-lift hover-border-glow group relative mx-3 flex h-40 w-64 flex-col items-start justify-center gap-2 overflow-hidden px-6 transition-colors hover:bg-white/5 cursor-pointer"
          @click="item.action"
        >

APIDMChannelBase | API | discord-api-types documentation
...
Inherited from APIPinChannel.flags

### [__](#id) __inheritedid

__id: string

Inherited from APIPinChannel.id
...
Inherited from APIPinChannel.last_pin_timestamp
...
Inherited from APITextBasedChannel.rate_limit_per_user
...
### [__](#recipients) __optionalrecipients
...
Inherited from APIPinChannel.type
...
Previous APIDMChannel Next APIEmbed

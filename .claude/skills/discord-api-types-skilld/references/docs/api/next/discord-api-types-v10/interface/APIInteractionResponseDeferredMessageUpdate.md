APIInteractionResponseDeferredMessageUpdate | API | discord-api-types documentation
...
__type: DeferredMessageUpdate

Previous APIInteractionResponseDeferredChannelMessageWithSource Next APIInteractionResponseLaunchActivity

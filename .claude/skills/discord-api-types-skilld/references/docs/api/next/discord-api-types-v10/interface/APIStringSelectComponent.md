APIStringSelectComponent | API | discord-api-types documentation
...
- APIBaseSelectMenuComponent<ComponentType.StringSelect>
  - _APIStringSelectComponent_
...
### [__](#options) __options

__options: APISelectMenuOption[]
...
Previous APIStickerPack Next APISubscription

...
**Deps:** @nuxt/kit@^4.3.0, local-pkg@^1.1.2, @vueuse/core@14.2.1, @vueuse/metadata@14.2.1
...
```bash
npx -y skilld search "query" -p @vueuse/nuxt
npx -y skilld search "issues:error handling" -p @vueuse/nuxt
npx -y skilld search "releases:deprecated" -p @vueuse/nuxt
```

APIMessageSearchResult | API | discord-api-types documentation
...
- [__documents_indexed](#documents_indexed)
- [__doing_deep_historical_index](#doing_deep_historical_index)
- [__members](#members)
- [__messages](#messages)
- [__threads](#threads)
- [__total_results](#total_results)

## Properties [__](#Properties)

### [__](#documents_indexed) __optionaldocuments_indexed

__documents_indexed?: number

The number of documents that have been indexed during the current index operation, if any

### [__](#doing_deep_historical_index) __doing_deep_historical_index

__doing_deep_historical_index: boolean

Whether the guild is undergoing a deep historical indexing operation

### [__](#members) __optionalmembers

__members?: APIThreadMember[]

A thread member object for each returned thread the current user has joined

### [__](#messages) __messages

__messages: Omit< APIMessage,reactions>[][]
...
### [__](#threads) __optionalthreads

__threads?: APIThreadChannel< ThreadChannelType>[]

The threads that contain the returned messages

### [__](#total_results) __total_results

__total_results: number

The total number of results that match the query

Previous APIMessageSearchIndexNotReadyResponse Next APIMessageSharedClientTheme

APIInteractionResponseLaunchActivity | API | discord-api-types documentation
...
__type: LaunchActivity

Previous APIInteractionResponseDeferredMessageUpdate Next APIInteractionResponsePong

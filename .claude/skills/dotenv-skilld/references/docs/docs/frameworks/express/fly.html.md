Deploy an Express.js App to Fly.io | Dotenv
...
```shell
flyctl secrets set NODE_ENV=production DOTENV_KEY='dotenv://: [\[email protected\]](https://www.dotenv.org/cdn-cgi/l/email-protection)/vault/.env.vault?environment=production'
```

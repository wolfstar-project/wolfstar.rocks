APIMessageMentionableSelectInteractionData | API | discord-api-types documentation
...
- APIMessageComponentBaseInteractionData<ComponentType.MentionableSelect>
  - _APIMessageMentionableSelectInteractionData_

## Index [__](#Index)

### Properties

- [__component_type](#component_type)
...
### [__](#component_type) __inheritedcomponent_type

__component_type: MentionableSelect

Inherited from APIMessageComponentBaseInteractionData.component_type
...
Inherited from APIMessageComponentBaseInteractionData.custom_id

The `custom_id` of the component

### [__](#resolved) __resolved

__resolved: Pick< APIInteractionDataResolved,members |users |roles>

### [__](#values) __values

__values: string[]

Previous APIMessageInteraction Next APIMessageMentions

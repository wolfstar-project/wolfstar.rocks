APIWebhookEventEventBase | API | discord-api-types documentation
...
# APIWebhookEventEventBase <Type,Data>
...
Previous APIWebhookEventBase Next BaseRPCCertifiedDevice

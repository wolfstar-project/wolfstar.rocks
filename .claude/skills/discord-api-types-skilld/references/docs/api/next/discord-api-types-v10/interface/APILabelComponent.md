APILabelComponent | API | discord-api-types documentation
...
- APIBaseComponent<ComponentType.Label>
  - _APILabelComponent_
...
### [__](#component) __component

__component: APIComponentInLabel
...
Previous APIInviteStageInstance Next APIMediaGalleryComponent

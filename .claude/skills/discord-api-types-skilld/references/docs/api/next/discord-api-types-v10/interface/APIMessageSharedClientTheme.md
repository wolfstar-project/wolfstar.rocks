APIMessageSharedClientTheme | API | discord-api-types documentation
...
- [__base_mix](#base_mix)
- [__base_theme](#base_theme)
- [__colors](#colors)
- [__gradient_angle](#gradient_angle)

## Properties [__](#Properties)

### [__](#base_mix) __base_mix

__base_mix: number

The intensity of the theme's colors (max of 100)

### [__](#base_theme) __optionalbase_theme

__base_theme?: null | BaseThemeType
...
### [__](#gradient_angle) __gradient_angle

__gradient_angle: number

The direction of the theme's colors (max of 360)

Previous APIMessageSearchResult Next APIMessageSnapshot

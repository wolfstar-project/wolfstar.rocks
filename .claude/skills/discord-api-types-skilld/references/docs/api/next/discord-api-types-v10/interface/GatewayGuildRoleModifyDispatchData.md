GatewayGuildRoleModifyDispatchData | API | discord-api-types documentation
...
Previous GatewayGuildRoleDeleteDispatchData Next GatewayGuildScheduledEventUserAddDispatchData

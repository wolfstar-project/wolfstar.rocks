...
Playwright provides a Pytest plugin to write end-to-end tests. To get started with it, refer to the [getting started guide](./intro.md).
...
Start Pytest with the `base-url` argument. The `pytest-base-url` plugin is used

...
```bash
skilld search "query" -p @vueuse/motion
skilld search "issues:error handling" -p @vueuse/motion
skilld search "releases:deprecated" -p @vueuse/motion
```

Filters: `docs:`, `issues:`, `releases:` prefix narrows by source type.

Related: vueuse-core-skilld, defu-skilld
